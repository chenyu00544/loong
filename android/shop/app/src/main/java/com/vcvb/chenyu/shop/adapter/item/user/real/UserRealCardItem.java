...
public class UserRealCardItem extends BaseItem<UserInfoBean> {
    public static final int TYPE = 3;

    public UserRealCardItem(UserInfoBean bean, Context c) {
        super(bean, c);
    }
    ...
    public CYCBaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        CYCBaseViewHolder base = new CYCBaseViewHolder(LayoutInflater.from(parent.getContext())
                .inflate(R.layout.user_real_card_item, null));
        return base;
    }
    ...
    public void onBindViewHolder(CYCBaseViewHolder holder, int position) {
        ...
        if (mData.getImgUriFront() != null) {
            Glide.with(context).load(mData.getImgUriFront()).into(iv1);
            iv3.setAlpha(255);
        } else {
        ...
        if (mData.getImgUriBack() != null) {
            Glide.with(context).load(mData.getImgUriBack()).into(iv2);
            iv4.setAlpha(255);
        } else {
