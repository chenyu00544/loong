...
public class EvaLReplyItem extends BaseItem<Comment> {
    public static final int TYPE = R.layout.evaluate_left_reply_item;
    public OnClickListener onClickListener;
    private int pos = 0;

    public EvaLReplyItem(Comment beans, Context c) {
        super(beans, c);
    }
    ...
    public void onBindViewHolder(CYCBaseViewHolder holder, int position) {
        ...
        if(mData.getComment_type() == 2){
            reply.setText(context.getResources().getString(R.string.review_evaluate));
        }else{
        ...
        ViewGroup.LayoutParams lp = new ViewGroup.LayoutParams(width / 5 - ToolUtils.dip2px
                (context, 16), width / 5 - ToolUtils.dip2px(context, 16));
        ...
        TextView tv3 = holder.get(R.id.textView295);
        tv3.setText(mData.getAdd_time_format());
        TextView tv4 = holder.get(R.id.textView294);
