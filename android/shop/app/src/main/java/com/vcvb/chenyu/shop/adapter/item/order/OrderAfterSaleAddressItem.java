...
public class OrderAfterSaleAddressItem extends BaseItem<OrderDetail> {
    public static final int TYPE = R.layout.order_after_sale_address_item;

    public OrderAfterSaleAddressItem(OrderDetail bean, Context c) {
        super(bean, c);
    }
