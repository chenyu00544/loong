...

    {
        ...
        if (!$this->IIIIIIIIl1ll) {
            ...
            if (!C('site_logo')) {
                ...
                $site_logo = 'tpl/Home/default/common/images/logo-iMicms.png';
            ...
            $this->IIIIIIII1II1 = $agent['id'];

            $this->IIIIIIII1IIl = $agent;

            $site_logo = $agent['sitelogo'];

            $IIIIIIII1I1l = $agent['sitename'];

            $IIIIIIII1I11 = $agent['sitetitle'];

            $IIIIIIII1lII = $agent['metakeywords'];

            $IIIIIIII1lIl = $agent['metades'];

            $IIIIIIII1lI1 = $agent['qq'];
            ...
            $IIIIIIII11Il = $agent['qrcode'];

            $IIIIIIII11I1 = $agent['siteurl'];

            $this->IIIIIIIIl1l1 = C('DEFAULT_THEME');

            if (file_exists($_SERVER['DOCUMENT_ROOT'] . '/tpl/Home/' . 'agent_' . $agent['id'])) {

                $this->IIIIIIIIl1l1 = 'agent_' . $agent['id'];

            }

            $IIIIIIII111I = $agent['regneedmp'];

            $this->IIIIIIIIl11I = $agent['needcheckuser'];
            ...
            $this->IIIIIIIIl111 = $agent['regvaliddays'];

            $this->IIIIIIII1III = C('reggid');

            $this->IIIIIIII1IlI = $agent['mp'];

            $IIIIIIII1ll1 = $agent['mp'];

        }

        $this->assign('f_tel', $IIIIIIII1ll1);

        $this->assign('f_logo', $site_logo);
