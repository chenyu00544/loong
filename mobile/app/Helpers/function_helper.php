...
//商家配送方式分单分组
function get_seller_shipping_order($ru_id = [], $shipping_id = [], $shipping_name = [], $shipping_code = [], $shipping_type = [])
{
...
function get_seller_cac_order($ru_id, $point_id, $shipping_dateStr)
{
    ...
    if ($point_id) {
        ...
        $cac = ['point_id' => $pointId, 'shipping_dateStr' => $dateStr];
    }
    return $cac;
}
