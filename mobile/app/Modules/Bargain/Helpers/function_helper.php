 ...
 * @return  商品最终购买价格
 */
function bargain_get_final_price($goods_id, $goods_num = '1', $is_spec_price = false, $spec = [], $warehouse_id = 0, $area_id = 0, $type = 0, $presale = 0, $add_tocart = 1, $show_goods = 0, $product_promote_price = 0) {
    ...
    /* 取得商品信息 */
    $sql = "SELECT g.shop_price, g.promote_start_date, g.promote_end_date, mp.user_price, g.user_id, g.model_price, g.model_attr " .
    ...
    if ($GLOBALS['_CFG']['add_shop_price'] == 1) {//商品SKU价格 SKU价格（商品价格 + 属性货品价格）
        $final_price = $goods['shop_price'];
        $final_price += $spec_price;
    } else {//商品SKU价格 SKU价格（属性货品价格）
        $final_price = $spec_price;
    }
