...
class IndexController extends FrontendController
{
    ...
    public function actionIndex()
    {
        ...
        if (IS_AJAX) {
            ...
            $arr = [];
            $sql = 'SELECT bg.id,bg.bargain_name,bg.start_time,bg.goods_price,bg.end_time,bg.target_price,bg.total_num,g.goods_id, g.goods_name, g.shop_price, g.market_price, g.goods_thumb , g.goods_img FROM ' . $this->ecs->table('bargain_goods') . 'AS bg LEFT JOIN ' . $this->ecs->table('goods') . ' AS g ON bg.goods_id = g.goods_id ' .
                "WHERE $where ";
