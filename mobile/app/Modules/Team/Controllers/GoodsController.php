...
class GoodsController extends FrontendController
{
    ...
    public function actionIndex()
    {
		...
		*/
		...
		if ($_SESSION ['user_id']) 
		{
			//get_user_pintuan_coupons_list
			
			$user_coupons = get_user_pintuan_coupons_list_goods($_SESSION['user_id'],$this->goods_id );
...
//        $goods_desc = preg_replace("/style=.+?[*|\"]/i", "", $goods_desc);
		...
		/////////////////////////////////////////////这里不显示免单的拼团订单。
		//team_goods_log 不变，加了team_goods_log2 
        $team_log = team_goods_log2($this->goods_id);
    ...
    public function actionPrice()
    {
        ...
        $onload = I('request.onload', '', ['htmlspecialchars','trim']);; //仓库管理的地区ID
