...
(259, 0, '生鲜-banner', 360, 168, '', '{foreach $ads as $ad}<div class="swiper-slide">{$ad}</div>{/foreach}', 0, 'ecmoban_dsc', 1, 'banner'),
(260, 0, '生鲜-left', 360, 168, '', '{foreach $ads as $ad}{$ad}{/foreach}', 0, 'ecmoban_dsc', 1, 'left'),
(261, 0, '生鲜-right', 360, 168, '', '{foreach $ads as $ad}{$ad}{/foreach}', 0, 'ecmoban_dsc', 1, 'right'),
(264, 0, '服装-left', 360, 168, '', '{foreach $ads as $ad}{$ad}{/foreach}', 0, 'ecmoban_dsc', 2, 'left'),
(262, 0, '生鲜-bottom', 360, 168, '', '{foreach $ads as $ad}{$ad}{/foreach}', 0, 'ecmoban_dsc', 1, 'bottom'),
(263, 0, '服装-banner', 360, 168, '', '{foreach $ads as $ad}<div class="swiper-slide">{$ad}</div>{/foreach}', 0, 'ecmoban_dsc', 2, 'banner'),
(265, 0, '服装-right', 360, 168, '', '{foreach $ads as $ad}{$ad}{/foreach}', 0, 'ecmoban_dsc', 2, 'right'),
(266, 0, '服装-bottom', 360, 168, '', '{foreach $ads as $ad}{$ad}{/foreach}', 0, 'ecmoban_dsc', 2, 'bottom');
