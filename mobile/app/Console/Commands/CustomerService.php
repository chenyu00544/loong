        ...
        $ws_worker->onMessage = function ($connection, $data) use ($ws_worker) {
            ...
            switch ($data['type']) {
                ...
                case 'sendmsg':
                     ...
                     * 发送消息
                     */
                    $msg = ['from_id' => $connection->uid, 'name' => $connection->uname, 'time' => date('H:i:s'), 'message' => $data['msg'], 'avatar' => $data['avatar'], 'goods_id' => $data['goods_id'], 'store_id' => $data['store_id'], 'message_type' => 'come_msg'];
