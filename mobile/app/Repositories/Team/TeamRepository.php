...
use App\Contracts\Repositories\Team\TeamRepositoryInterface;
...
class TeamRepository implements TeamRepositoryInterface
{
    ...
    public function teamGoodsList($page = 1, $size = 10 ,$type = [])
    {
        $goods = TeamGoods::from('team_goods as tg')
            ->select('g.goods_id', 'g.goods_name', 'g.shop_price','g.goods_number', 'g.sales_volume','g.goods_thumb', 'g.market_price', 'tg.id', 'tg.team_price', 'tg.team_num','tg.limit_num')
