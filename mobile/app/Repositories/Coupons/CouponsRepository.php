...
use App\Contracts\Repositories\Coupons\CouponsRepositoryInterface;
...
class CouponsRepository implements CouponsRepositoryInterface
{
    ...
    function getCouponsLists($status = 0, $uid)
    {
        ...
        $sql = "SELECT c.*, cu.*, o.order_sn, o.add_time FROM " . $prefix. "coupons_user AS cu LEFT JOIN " . $prefix. "coupons AS c ON c.cou_id = cu.cou_id " .
            $left_join .
