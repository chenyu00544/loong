                            ...
                            <tr>
                                <td class="capt-td">
                                    <div class="fl wd-750">
                                        ...
                                        <p>
                                            <img src="{{url('api/web/captcha')}}" alt="captcha" class="captcha-img"></p>
                                    </div>
                                    <div class="fl mar-left-20">
                                        <ul>
                                            <li class="wd80">
                                                <a class="cursor sel-all">
                                                    <input type="checkbox" name="captcha_register"
                                                           id="captcha_register">
                                ...
                                <td class="capt-td">
                                    ...
                                    <div class="fl mar-left-20 pad-top-30">
                                        <label class="radio-inline fl">
                                            <input type="radio" name="captcha_login_fail" value="32" checked="true"> 是
                                        </label>
                                        <label class="radio-inline fl">
                                            <input type="radio" name="captcha_login_fail" value="0"> 否
                                        </label>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td class="capt-td">
                                    ...
                                    <div class="fl mar-left-20 pad-top-13">
                                        <input type="text" name="captcha_width" class="form-control" value="112" placeholder="宽度">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td class="capt-td">
                                    ...
                                    <div class="fl mar-left-20 pad-top-13">
                                            <input type="text" name="captcha_height" class="form-control" value="20" placeholder="高度">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td class="capt-td">
                                    ...
                                    <div class="fl mar-left-20 pad-top-13">
                                        <input type="text" name="captcha_font_size" class="form-control" value="16" placeholder="验证码内容大小">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td class="capt-td">
                                    ...
                                    <div class="fl mar-left-20">
                                        <input type="text" name="captcha_length" class="form-control" value="4" placeholder="验证码位数">
                                    </div>
                                </td>
                            </tr>
                            <tr>
