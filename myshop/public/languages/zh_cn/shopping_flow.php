...
$_LANG['far_ext']['all'] = '全部商品';
$_LANG['far_ext']['brand'] = '以下品牌';
$_LANG['far_ext']['category'] = '以下分类';
$_LANG['far_ext']['goods'] = '以下商品';
$_LANG['favourable_amount'] = '金额区间：';
$_LANG['favourable_type'] = '优惠方式：';
$_LANG['fat_ext']['discount'] = '享受 %d%% 的折扣';
$_LANG['fat_ext']['largess'] = '从下面的赠品（特惠品）中选择 %d 个（0表示不限制数量）';
$_LANG['fat_ext']['price'] = '直接减少现金 %d';
