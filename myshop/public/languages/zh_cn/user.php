...
/* 留言类型 */
$_LANG['type']['message'] = '留言';
$_LANG['type']['complaint'] = '投诉';
$_LANG['type']['enquiry'] = '询问';
$_LANG['type']['custome'] = '售后';
$_LANG['type']['buy'] = '求购';
$_LANG['type']['business'] = '商家留言';
...
/* 订单状态 */
$_LANG['os']['unconfirmed'] = '未确认';
$_LANG['os']['confirmed'] = '已确认';
$_LANG['os']['splited'] = '已确认';
$_LANG['os']['spliting_part'] = '已确认';
$_LANG['os']['canceled'] = '已取消';
$_LANG['os']['invalid'] = '无效';
$_LANG['os']['returned'] = '退货';

$_LANG['ss']['unshipped'] = '未发货';
$_LANG['ss']['preparing'] = '配货中';
$_LANG['ss']['shipped'] = '已发货';
$_LANG['ss']['received'] = '收货确认';
$_LANG['ss']['shipped_part'] = '已发货(部分商品)';
$_LANG['ss']['shipped_ing'] = '配货中'; // 已分单

$_LANG['ps']['unpayed'] = '未付款';
$_LANG['ps']['paying'] = '付款中';
$_LANG['ps']['payed'] = '已付款';
