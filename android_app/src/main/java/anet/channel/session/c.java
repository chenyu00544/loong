...
public class c {
    ...
    public static a a(Request request, RequestCb requestCb) {
        ...
        while (NetworkStatusHelper.f()) {
            try {
                if (ALog.isPrintLog(2)) {
                    ALog.i("awcn.HttpConnector", "", request.getSeq(), "request URL", request.getUrlString());
                ...
                if (httpURLConnection2 != null) {
                    ...
                    aVar.c = anet.channel.util.c.a(httpURLConnection2.getHeaderFields());
                    ...
                    if (anet.channel.util.c.a(request, aVar.a)) {
                        String b = anet.channel.util.c.b(aVar.c, "Location");
                        if (b != null) {
                            e a = e.a(b);
                            if (a != null) {
                                a.h();
                    ...
                    if (aVar.a != 304 && aVar.a != g.c && (aVar.a < 100 || aVar.a >= 200)) {
                        if (!(anet.channel.util.c.b(aVar.c) || requestCb == null)) {
    ...
    private static void a(Request request, a aVar, RequestCb requestCb, int i, Throwable th) {
        ...
        ALog.e("awcn.HttpConnector", "onException", request.getSeq(), Constants.KEY_ERROR_CODE, Integer.valueOf(i), "errMsg", errMsg, "url", request.getUrlString(), "host", request.getHost());
        if (aVar != null) {
            aVar.a = i;
        }
    ...
    private static HttpURLConnection a(Request request) throws IOException {
        Proxy proxy;
        f fVar;
        Pair i = NetworkStatusHelper.i();
        if (i != null) {
            proxy = new Proxy(Type.HTTP, new InetSocketAddress((String) i.first, ((Integer) i.second).intValue()));
        } else {
            proxy = null;
        }
    ...
    private static void a(HttpURLConnection httpURLConnection, Request request) {
        ...
        if (d.b() != null) {
            ...
            httpsURLConnection.setHostnameVerifier(d.ALLOW_ALL_HOSTNAME_VERIFIER);
        }
    }
    ...
    private static void a(HttpURLConnection httpURLConnection, Request request, a aVar, RequestCb requestCb) throws IOException, CancellationException {
        ...
        try {
            ...
            try {
                ...
                Throwable e22;
                ALog.e("awcn.HttpConnector", "get error stream failed." + httpURLConnection.getURL().toString(), request.getSeq(), e22, new Object[0]);
                errorStream = null;
            }
        ...
        boolean b = anet.channel.util.c.b(aVar.c);
        if (b) {
