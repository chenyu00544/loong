...
public class SlidingPaneLayout extends ViewGroup {
    ...
    static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new SlidingPaneLayout_SavedState_1();
        boolean isOpen;

        static class SlidingPaneLayout_SavedState_1 implements Creator<SavedState> {
            SlidingPaneLayout_SavedState_1() {
            }
