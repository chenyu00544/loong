...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingChild, NestedScrollingParent {
    ...
    class SwipeRefreshLayout_1 implements AnimationListener {
        SwipeRefreshLayout_1() {
        }
    ...
    class SwipeRefreshLayout_2 extends Animation {
        SwipeRefreshLayout_2() {
        }
    ...
    class SwipeRefreshLayout_3 extends Animation {
        SwipeRefreshLayout_3() {
        }
    ...
    class SwipeRefreshLayout_5 implements AnimationListener {
        SwipeRefreshLayout_5() {
        }
    ...
    class SwipeRefreshLayout_6 extends Animation {
        SwipeRefreshLayout_6() {
        }
    ...
    class SwipeRefreshLayout_7 extends Animation {
        SwipeRefreshLayout_7() {
        }
    ...
    class SwipeRefreshLayout_8 extends Animation {
        SwipeRefreshLayout_8() {
        }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mRefreshListener = new SwipeRefreshLayout_1();
        this.mAnimateToCorrectPosition = new SwipeRefreshLayout_6();
        this.mAnimateToStartPosition = new SwipeRefreshLayout_7();
    ...
    private void startScaleUpAnimation(AnimationListener animationListener) {
        ...
        this.mScaleAnimation = new SwipeRefreshLayout_2();
    ...
    private void startScaleDownAnimation(AnimationListener animationListener) {
        this.mScaleDownAnimation = new SwipeRefreshLayout_3();
    ...
    private Animation startAlphaAnimation(final int i, final int i2) {
        ...
        Animation swipeRefreshLayout_4 = new Animation() {
            public void applyTransformation(float f, Transformation transformation) {
                SwipeRefreshLayout.this.mProgress.setAlpha((int) (((float) i) + (((float) (i2 - i)) * f)));
            }
        };
        swipeRefreshLayout_4.setDuration(300);
        this.mCircleView.setAnimationListener(null);
        this.mCircleView.clearAnimation();
        this.mCircleView.startAnimation(swipeRefreshLayout_4);
        return swipeRefreshLayout_4;
    }
    ...
    private void finishSpinner(float f) {
        ...
        if (!this.mScale) {
            animationListener = new SwipeRefreshLayout_5();
        }
    ...
    private void startScaleDownReturnToStartAnimation(int i, AnimationListener animationListener) {
        ...
        this.mScaleDownToStartAnimation = new SwipeRefreshLayout_8();
