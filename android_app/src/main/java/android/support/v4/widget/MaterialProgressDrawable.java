...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private final Callback mCallback = new MaterialProgressDrawable_3();
    boolean mFinishing;
    ...
    class MaterialProgressDrawable_3 implements Callback {
        MaterialProgressDrawable_3() {
        }
    ...
    private void setupAnimators() {
        ...
        Animation materialProgressDrawable_1 = new Animation() {
        ...
        materialProgressDrawable_1.setRepeatCount(-1);
        materialProgressDrawable_1.setRepeatMode(1);
        materialProgressDrawable_1.setInterpolator(LINEAR_INTERPOLATOR);
        materialProgressDrawable_1.setAnimationListener(new AnimationListener() {
        ...
        this.mAnimation = materialProgressDrawable_1;
    }
}
