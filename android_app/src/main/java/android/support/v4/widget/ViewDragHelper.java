...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new ViewDragHelper_1();
    ...
    private final Runnable mSetIdleRunnable = new ViewDragHelper_2();
    ...
    static class ViewDragHelper_1 implements Interpolator {
        ViewDragHelper_1() {
        }
    ...
    class ViewDragHelper_2 implements Runnable {
        ViewDragHelper_2() {
        }
