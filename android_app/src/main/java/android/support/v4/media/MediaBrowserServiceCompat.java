...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    private void performLoadChildren(String str, ConnectionRecord connectionRecord, Bundle bundle) {
        ...
        final String str2 = str;
        final Bundle bundle2 = bundle;
        Result mediaBrowserServiceCompat_3 = new Result<List<MediaItem>>(str) {
        ...
        if (bundle == null) {
            onLoadChildren(str, mediaBrowserServiceCompat_3);
        } else {
            onLoadChildren(str, mediaBrowserServiceCompat_3, bundle);
        }
        if (!mediaBrowserServiceCompat_3.isDone()) {
    ...
    private void performLoadItem(String str, final ResultReceiver resultReceiver) {
        Result mediaBrowserServiceCompat_4 = new Result<MediaItem>(str) {
        ...
        onLoadItem(str, mediaBrowserServiceCompat_4);
        if (!mediaBrowserServiceCompat_4.isDone()) {
