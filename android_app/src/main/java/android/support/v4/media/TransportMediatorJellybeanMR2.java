...
class TransportMediatorJellybeanMR2 {
    OnAudioFocusChangeListener mAudioFocusChangeListener = new TransportMediatorJellybeanMR2_4();
    boolean mAudioFocused;
    final AudioManager mAudioManager;
    final Context mContext;
    boolean mFocused;
    final OnGetPlaybackPositionListener mGetPlaybackPositionListener = new TransportMediatorJellybeanMR2_5();
    final Intent mIntent;
    final BroadcastReceiver mMediaButtonReceiver = new TransportMediatorJellybeanMR2_3();
    PendingIntent mPendingIntent;
    int mPlayState = 0;
    final OnPlaybackPositionUpdateListener mPlaybackPositionUpdateListener = new TransportMediatorJellybeanMR2_6();
    final String mReceiverAction;
    final IntentFilter mReceiverFilter;
    RemoteControlClient mRemoteControl;
    final View mTargetView;
    final TransportMediatorCallback mTransportCallback;
    final OnWindowAttachListener mWindowAttachListener = new TransportMediatorJellybeanMR2_1();
    final OnWindowFocusChangeListener mWindowFocusListener = new TransportMediatorJellybeanMR2_2();

    class TransportMediatorJellybeanMR2_1 implements OnWindowAttachListener {
        TransportMediatorJellybeanMR2_1() {
        }
    ...
    class TransportMediatorJellybeanMR2_2 implements OnWindowFocusChangeListener {
        TransportMediatorJellybeanMR2_2() {
        }
    ...
    class TransportMediatorJellybeanMR2_3 extends BroadcastReceiver {
        TransportMediatorJellybeanMR2_3() {
        }
    ...
    class TransportMediatorJellybeanMR2_4 implements OnAudioFocusChangeListener {
        TransportMediatorJellybeanMR2_4() {
        }
    ...
    class TransportMediatorJellybeanMR2_5 implements OnGetPlaybackPositionListener {
        TransportMediatorJellybeanMR2_5() {
        }
    ...
    class TransportMediatorJellybeanMR2_6 implements OnPlaybackPositionUpdateListener {
        TransportMediatorJellybeanMR2_6() {
        }
