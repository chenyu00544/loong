...
public class MediaSessionCompat {
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private android.support.v4.media.VolumeProviderCompat.Callback mVolumeCallback = new MediaSessionCompat_MediaSessionImplBase_1();
        private VolumeProviderCompat mVolumeProvider;
        private int mVolumeType;

        class MediaSessionCompat_MediaSessionImplBase_1 extends android.support.v4.media.VolumeProviderCompat.Callback {
            MediaSessionCompat_MediaSessionImplBase_1() {
            }
        ...
        class MediaSessionCompat_MediaSessionImplBase_2 implements Callback {
            MediaSessionCompat_MediaSessionImplBase_2() {
            }
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            Object mediaSessionCompat_MediaSessionImplBase_2 = new MediaSessionCompat_MediaSessionImplBase_2();
            if (VERSION.SDK_INT >= 18) {
                MediaSessionCompatApi18.setOnPlaybackPositionUpdateListener(this.mRccObj, MediaSessionCompatApi18.createPlaybackPositionUpdateListener(mediaSessionCompat_MediaSessionImplBase_2));
            }
            if (VERSION.SDK_INT >= 19) {
                MediaSessionCompatApi19.setOnMetadataUpdateListener(this.mRccObj, MediaSessionCompatApi19.createMetadataUpdateListener(mediaSessionCompat_MediaSessionImplBase_2));
            }
        }
    ...
    public static final class QueueItem implements Parcelable {
        public static final Creator<QueueItem> CREATOR = new MediaSessionCompat_QueueItem_1();
        public static final int UNKNOWN_ID = -1;
        private final MediaDescriptionCompat mDescription;
        private final long mId;
        private Object mItem;

        static class MediaSessionCompat_QueueItem_1 implements Creator<QueueItem> {
            MediaSessionCompat_QueueItem_1() {
            }
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        public static final Creator<ResultReceiverWrapper> CREATOR = new MediaSessionCompat_ResultReceiverWrapper_1();
        private ResultReceiver mResultReceiver;

        static class MediaSessionCompat_ResultReceiverWrapper_1 implements Creator<ResultReceiverWrapper> {
            MediaSessionCompat_ResultReceiverWrapper_1() {
            }
    ...
    public static final class Token implements Parcelable {
        public static final Creator<Token> CREATOR = new MediaSessionCompat_Token_1();
        private final Object mInner;

        static class MediaSessionCompat_Token_1 implements Creator<Token> {
            MediaSessionCompat_Token_1() {
            }
