...
public class TransportMediator extends TransportController {
    ...
    class TransportMediator_1 implements TransportMediatorCallback {
        TransportMediator_1() {
        }
    ...
    class TransportMediator_2 implements Callback {
        TransportMediator_2() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer transportPerformer) {
        ...
        this.mTransportKeyCallback = new TransportMediator_1();
        this.mKeyEventCallback = new TransportMediator_2();
