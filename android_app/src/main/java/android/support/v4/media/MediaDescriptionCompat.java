...
public final class MediaDescriptionCompat implements Parcelable {
    public static final Creator<MediaDescriptionCompat> CREATOR = new MediaDescriptionCompat_1();
    ...
    static class MediaDescriptionCompat_1 implements Creator<MediaDescriptionCompat> {
        MediaDescriptionCompat_1() {
        }
