...
public final class MediaMetadataCompat implements Parcelable {
    public static final Creator<MediaMetadataCompat> CREATOR = new MediaMetadataCompat_1();
    ...
    static class MediaMetadataCompat_1 implements Creator<MediaMetadataCompat> {
        MediaMetadataCompat_1() {
        }
