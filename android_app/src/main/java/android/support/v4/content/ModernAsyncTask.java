...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new ModernAsyncTask_1();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new ModernAsyncTask_2();

    static class ModernAsyncTask_1 implements ThreadFactory {
    ...
    class ModernAsyncTask_2 extends WorkerRunnable<Params, Result> {
        ModernAsyncTask_2() {
            super();
        }
