...
final class BackStackRecord extends FragmentTransaction implements BackStackEntry, Runnable {
    ...
    private boolean configureTransitions(int i, TransitionState transitionState, boolean z, SparseArray<Fragment> sparseArray, SparseArray<Fragment> sparseArray2) {
        ...
        View view2;
        ViewRetriever backStackRecord_1;
        ...
        if (sharedElementTransition != null) {
            ...
            if (map.isEmpty()) {
                ...
                backStackRecord_1 = new ViewRetriever() {
                    public View getView() {
                ...
                if (mergeTransitions != null) {
                    FragmentTransitionCompat21.addTransitionTargets(enterTransition, obj, view, backStackRecord_1, transitionState.nonExistentView, transitionState.enteringEpicenterView, transitionState.nameOverrides, arrayList2, map, arrayMap, arrayList3);
        ...
        backStackRecord_1 = /* anonymous class already generated */;
        arrayList2 = new ArrayList();
        arrayMap = new ArrayMap();
        z2 = true;
        if (fragment != null) {
