...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflaterFactory {
    ...
    int mCurState = 0;
    boolean mDestroyed;
    Runnable mExecCommit = new FragmentManagerImpl_1();
    ...
    /* compiled from: FragmentManager */
    class FragmentManagerImpl_1 implements Runnable {
        FragmentManagerImpl_1() {
        }
    ...
    /* compiled from: FragmentManager */
    class FragmentManagerImpl_2 implements Runnable {
        FragmentManagerImpl_2() {
        }
    ...
    static class AnimateOnHWLayerIfNeededListener implements AnimationListener {
        ...
        /* compiled from: FragmentManager */
        class FragmentManagerImpl_AnimateOnHWLayerIfNeededListener_1 implements Runnable {
            FragmentManagerImpl_AnimateOnHWLayerIfNeededListener_1() {
            }
        ...
        /* compiled from: FragmentManager */
        class FragmentManagerImpl_AnimateOnHWLayerIfNeededListener_2 implements Runnable {
            FragmentManagerImpl_AnimateOnHWLayerIfNeededListener_2() {
            }
        ...
        public void onAnimationStart(Animation animation) {
            if (this.mView != null) {
                ...
                if (this.mShouldRunOnHWLayer) {
                    this.mView.post(new FragmentManagerImpl_AnimateOnHWLayerIfNeededListener_1());
                }
            }
        ...
        public void onAnimationEnd(Animation animation) {
            if (this.mView != null && this.mShouldRunOnHWLayer) {
                this.mView.post(new FragmentManagerImpl_AnimateOnHWLayerIfNeededListener_2());
            }
            if (this.mOrignalListener != null) {
    ...
    public void popBackStack() {
        enqueueAction(new FragmentManagerImpl_2(), false);
    }
