...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener {
    ...
    class Fragment_1 extends FragmentContainer {
        Fragment_1() {
        }
    ...
    public static class SavedState implements Parcelable {
        public static final Creator<SavedState> CREATOR = new Fragment_SavedState_1();
        final Bundle mState;

        static class Fragment_SavedState_1 implements Creator<SavedState> {
            Fragment_SavedState_1() {
            }
    ...
    void instantiateChildFragmentManager() {
        ...
        this.mChildFragmentManager.attachController(this.mHost, new Fragment_1(), this);
    }
