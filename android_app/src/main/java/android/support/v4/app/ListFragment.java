...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new ListFragment_2();
    View mProgressContainer;
    private final Runnable mRequestFocus = new ListFragment_1();
    TextView mStandardEmptyView;

    class ListFragment_1 implements Runnable {
        ListFragment_1() {
        }
    ...
    class ListFragment_2 implements OnItemClickListener {
        ListFragment_2() {
        }
