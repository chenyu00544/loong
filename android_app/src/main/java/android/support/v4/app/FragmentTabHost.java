...
public class FragmentTabHost extends TabHost implements OnTabChangeListener {
    ...
    static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new FragmentTabHost_SavedState_1();
        String curTab;

        static class FragmentTabHost_SavedState_1 implements Creator<SavedState> {
            FragmentTabHost_SavedState_1() {
            }
