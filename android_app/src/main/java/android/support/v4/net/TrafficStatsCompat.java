...
public final class TrafficStatsCompat {
    ...
    static class BaseTrafficStatsCompatImpl implements TrafficStatsCompatImpl {
        private ThreadLocal<SocketTags> mThreadSocketTags = new TrafficStatsCompat_BaseTrafficStatsCompatImpl_1();

        class TrafficStatsCompat_BaseTrafficStatsCompatImpl_1 extends ThreadLocal<SocketTags> {
            TrafficStatsCompat_BaseTrafficStatsCompatImpl_1() {
            }
