...
class DonutAnimatorCompatProvider implements AnimatorProvider {
    ...
    private static class DonutFloatValueAnimator implements ValueAnimatorCompat {
        ...
        private Runnable mLoopRunnable = new DonutAnimatorCompatProvider_DonutFloatValueAnimator_1();
        private long mStartTime;
        private boolean mStarted = false;
        View mTarget;
        List<AnimatorUpdateListenerCompat> mUpdateListeners = new ArrayList();

        class DonutAnimatorCompatProvider_DonutFloatValueAnimator_1 implements Runnable {
            DonutAnimatorCompatProvider_DonutFloatValueAnimator_1() {
            }
