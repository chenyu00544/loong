...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    class PagerTabStrip_1 implements OnClickListener {
        PagerTabStrip_1() {
        }
    ...
    class PagerTabStrip_2 implements OnClickListener {
        PagerTabStrip_2() {
        }
    ...
    public PagerTabStrip(Context context, AttributeSet attributeSet) {
        ...
        this.mPrevText.setOnClickListener(new PagerTabStrip_1());
        this.mNextText.setFocusable(true);
        this.mNextText.setOnClickListener(new PagerTabStrip_2());
