...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new ViewPager_1();
    ...
    private static final Interpolator sInterpolator = new ViewPager_2();
    ...
    private final Runnable mEndScrollRunnable = new ViewPager_3();
    ...
    static class ViewPager_1 implements Comparator<ItemInfo> {
        ViewPager_1() {
        }
    ...
    static class ViewPager_2 implements Interpolator {
        ViewPager_2() {
        }
    ...
    class ViewPager_3 implements Runnable {
        ViewPager_3() {
        }
    ...
    class ViewPager_4 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new ViewPager_SavedState_1());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        static class ViewPager_SavedState_1 implements ParcelableCompatCreatorCallbacks<SavedState> {
            ViewPager_SavedState_1() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new ViewPager_4());
    }
        ...
        for (int i5 = 0; i5 < childCount; i5++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams != null && layoutParams.isDecor) {
                    ...
                    int i7 = layoutParams.gravity & g.if;
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        while (i8 < childCount) {
            ...
            if (childAt.getVisibility() != 8) {
                layoutParams = (LayoutParams) childAt.getLayoutParams();
                if (layoutParams.isDecor) {
                    int i9 = layoutParams.gravity & g.if;
