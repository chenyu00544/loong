...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    private final OnClickListener mOnClickListener = new NavigationMenuPresenter_1();
    ...
    class NavigationMenuPresenter_1 implements OnClickListener {
        NavigationMenuPresenter_1() {
        }
