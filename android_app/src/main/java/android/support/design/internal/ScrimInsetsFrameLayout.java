...
public class ScrimInsetsFrameLayout extends FrameLayout {
    ...
    class ScrimInsetsFrameLayout_1 implements OnApplyWindowInsetsListener {
        ScrimInsetsFrameLayout_1() {
        }
    ...
    public ScrimInsetsFrameLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        setWillNotDraw(true);
        ViewCompat.setOnApplyWindowInsetsListener(this, new ScrimInsetsFrameLayout_1());
    }
