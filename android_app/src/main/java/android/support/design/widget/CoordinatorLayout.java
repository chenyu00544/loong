...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent {
    ...
    class CoordinatorLayout_1 implements Comparator<View> {
        CoordinatorLayout_1() {
        }
    ...
    protected static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new CoordinatorLayout_SavedState_1());
        SparseArray<Parcelable> behaviorStates;

        static class CoordinatorLayout_SavedState_1 implements ParcelableCompatCreatorCallbacks<SavedState> {
            CoordinatorLayout_SavedState_1() {
            }
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mLayoutDependencyComparator = new CoordinatorLayout_1();
    ...
    void getDesiredAnchoredChildRect(View view, int i, Rect rect, Rect rect2) {
        ...
        int i3 = absoluteGravity & g.if;
        absoluteGravity = absoluteGravity2 & 7;
        int i4 = absoluteGravity2 & g.if;
