...
class ValueAnimatorCompatImplEclairMr1 extends Impl {
    ...
    private final Runnable mRunnable = new ValueAnimatorCompatImplEclairMr1_1();
    private long mStartTime;
    private AnimatorUpdateListenerProxy mUpdateListener;

    class ValueAnimatorCompatImplEclairMr1_1 implements Runnable {
        ValueAnimatorCompatImplEclairMr1_1() {
        }
