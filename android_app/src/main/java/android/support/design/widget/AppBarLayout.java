...
public class AppBarLayout extends LinearLayout {
    ...
    class AppBarLayout_1 implements OnApplyWindowInsetsListener {
        AppBarLayout_1() {
        }
    ...
    public static class Behavior extends HeaderBehavior<AppBarLayout> {
        ...
        protected static class SavedState extends BaseSavedState {
            public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new AppBarLayout_Behavior_SavedState_1());
            boolean firstVisibileChildAtMinimumHeight;
            float firstVisibileChildPercentageShown;
            int firstVisibleChildIndex;

            static class AppBarLayout_Behavior_SavedState_1 implements ParcelableCompatCreatorCallbacks<SavedState> {
                AppBarLayout_Behavior_SavedState_1() {
                }
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new AppBarLayout_1());
    }
