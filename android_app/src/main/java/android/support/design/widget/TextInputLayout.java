...
public class TextInputLayout extends LinearLayout {
    ...
    class TextInputLayout_1 implements TextWatcher {
        TextInputLayout_1() {
        }
    ...
    class TextInputLayout_2 extends ViewPropertyAnimatorListenerAdapter {
        TextInputLayout_2() {
        }
    ...
    class TextInputLayout_4 implements AnimatorUpdateListener {
        TextInputLayout_4() {
        }
    ...
    static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new TextInputLayout_SavedState_1();
        CharSequence error;

        static class TextInputLayout_SavedState_1 implements Creator<SavedState> {
            TextInputLayout_SavedState_1() {
            }
    ...
    private void setEditText(EditText editText) {
        ...
        this.mEditText.addTextChangedListener(new TextInputLayout_1());
        ...
        if (!TextUtils.equals(this.mError, charSequence)) {
            ...
            if (this.mErrorShown) {
                ...
                if (isLaidOut) {
                    ...
                    ViewCompat.animate(this.mErrorView).alpha(1.0f).setDuration(200).setInterpolator(AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR).setListener(new TextInputLayout_2()).start();
                }
    ...
    private void animateToExpansionFraction(float f) {
        if (this.mCollapsingTextHelper.getExpansionFraction() != f) {
            if (this.mAnimator == null) {
                ...
                this.mAnimator.setUpdateListener(new TextInputLayout_4());
            }
