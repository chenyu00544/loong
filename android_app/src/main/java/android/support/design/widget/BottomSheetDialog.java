...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    class BottomSheetDialog_1 implements OnClickListener {
        BottomSheetDialog_1() {
        }
    ...
    class BottomSheetDialog_2 extends BottomSheetCallback {
        BottomSheetDialog_2() {
        }
    ...
    public BottomSheetDialog(@NonNull Context context, @StyleRes int i) {
        ...
        this.mBottomSheetCallback = new BottomSheetDialog_2();
    ...
    private View wrapInBottomSheet(int i, View view, LayoutParams layoutParams) {
        ...
        if (shouldWindowCloseOnTouchOutside()) {
            coordinatorLayout.findViewById(R.id.touch_outside).setOnClickListener(new BottomSheetDialog_1());
        }
