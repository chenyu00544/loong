...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    class NavigationView_1 implements Callback {
        NavigationView_1() {
        }
    ...
    public static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new NavigationView_SavedState_1());
        public Bundle menuState;

        static class NavigationView_SavedState_1 implements ParcelableCompatCreatorCallbacks<SavedState> {
            NavigationView_SavedState_1() {
            }
    ...
    public NavigationView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mMenu.setCallback(new NavigationView_1());
