...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    class CollapsingToolbarLayout_1 implements OnApplyWindowInsetsListener {
        CollapsingToolbarLayout_1() {
        }
    ...
    class CollapsingToolbarLayout_2 implements AnimatorUpdateListener {
        CollapsingToolbarLayout_2() {
        }
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new CollapsingToolbarLayout_1());
    }
    ...
    private void animateScrim(int i) {
        ...
        if (this.mScrimAnimator == null) {
            ...
            this.mScrimAnimator.setUpdateListener(new CollapsingToolbarLayout_2());
