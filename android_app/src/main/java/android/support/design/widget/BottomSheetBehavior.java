...
public class BottomSheetBehavior<V extends View> extends Behavior<V> {
    ...
    private final Callback mDragCallback = new BottomSheetBehavior_1();
    ...
    class BottomSheetBehavior_1 extends Callback {
        BottomSheetBehavior_1() {
        }
    ...
    protected static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new BottomSheetBehavior_SavedState_1();
        final int state;

        static class BottomSheetBehavior_SavedState_1 implements Creator<SavedState> {
            BottomSheetBehavior_SavedState_1() {
            }
    ...
    public boolean onTouchEvent(CoordinatorLayout coordinatorLayout, V v, MotionEvent motionEvent) {
        ...
        this.mVelocityTracker.addMovement(motionEvent);
        if (actionMasked != 2 || Math.abs(((float) this.mInitialY) - motionEvent.getY()) <= ((float) this.mViewDragHelper.getTouchSlop())) {
            return true;
        }
