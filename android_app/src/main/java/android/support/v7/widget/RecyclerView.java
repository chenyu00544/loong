...
public class RecyclerView extends ViewGroup implements NestedScrollingChild, ScrollingView {
    ...
    private static final Interpolator sQuinticInterpolator = new RecyclerView_3();
    ...
    class RecyclerView_1 implements Runnable {
        RecyclerView_1() {
        }
    ...
    class RecyclerView_2 implements Runnable {
        RecyclerView_2() {
        }
    ...
    static class RecyclerView_3 implements Interpolator {
        RecyclerView_3() {
        }
    ...
    class RecyclerView_4 implements ProcessCallback {
        RecyclerView_4() {
        }
    ...
    class RecyclerView_5 implements Callback {
        RecyclerView_5() {
        }
    ...
    class RecyclerView_6 implements Callback {
        RecyclerView_6() {
        }
    ...
    public static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new RecyclerView_SavedState_1();
        Parcelable mLayoutState;

        static class RecyclerView_SavedState_1 implements Creator<SavedState> {
            RecyclerView_SavedState_1() {
            }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mUpdateChildViewsRunnable = new RecyclerView_1();
        ...
        this.mItemAnimatorRunner = new RecyclerView_2();
        this.mViewInfoProcessCallback = new RecyclerView_4();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new RecyclerView_5());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new RecyclerView_6());
    }
