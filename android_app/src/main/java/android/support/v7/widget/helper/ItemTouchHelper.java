...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    private final OnItemTouchListener mOnItemTouchListener = new ItemTouchHelper_2();
    private View mOverdrawChild = null;
    private int mOverdrawChildPosition = -1;
    final List<View> mPendingCleanup = new ArrayList();
    List<RecoverAnimation> mRecoverAnimations = new ArrayList();
    private RecyclerView mRecyclerView;
    private final Runnable mScrollRunnable = new ItemTouchHelper_1();
    ...
    class ItemTouchHelper_1 implements Runnable {
        ItemTouchHelper_1() {
        }
    ...
    class ItemTouchHelper_2 implements OnItemTouchListener {
        ItemTouchHelper_2() {
        }
    ...
    class ItemTouchHelper_5 implements ChildDrawingOrderCallback {
        ItemTouchHelper_5() {
        }
    ...
    public static abstract class Callback {
        ...
        private static final Interpolator sDragScrollInterpolator = new ItemTouchHelper_Callback_1();
        private static final Interpolator sDragViewScrollCapInterpolator = new ItemTouchHelper_Callback_2();
        private static final ItemTouchUIUtil sUICallback;
        private int mCachedMaxScrollSpeed = -1;

        static class ItemTouchHelper_Callback_1 implements Interpolator {
            ItemTouchHelper_Callback_1() {
            }
        ...
        static class ItemTouchHelper_Callback_2 implements Interpolator {
            ItemTouchHelper_Callback_2() {
            }
        ...
        if (viewHolder != this.mSelected || i != this.mActionState) {
            ...
            if (this.mSelected != null) {
                ...
                if (viewHolder2.itemView.getParent() != null) {
                    ...
                    RecoverAnimation itemTouchHelper_3 = new RecoverAnimation(viewHolder2, i4, i2, f2, f3, f, signum) {
                        public void onAnimationEnd(ValueAnimatorCompat valueAnimatorCompat) {
                    ...
                    itemTouchHelper_3.setDuration(this.mCallback.getAnimationDuration(this.mRecyclerView, i4, f - f2, signum - f3));
                    this.mRecoverAnimations.add(itemTouchHelper_3);
                    itemTouchHelper_3.start();
                    obj = 1;
                } else {
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new ItemTouchHelper_5();
            }
