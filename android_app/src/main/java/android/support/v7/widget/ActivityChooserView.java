...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    class ActivityChooserView_1 extends DataSetObserver {
        ActivityChooserView_1() {
        }
    ...
    class ActivityChooserView_2 implements OnGlobalLayoutListener {
        ActivityChooserView_2() {
        }
    ...
    class ActivityChooserView_4 extends DataSetObserver {
        ActivityChooserView_4() {
        }
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mModelDataSetOberver = new ActivityChooserView_1();
        this.mOnGlobalLayoutListener = new ActivityChooserView_2();
        ...
        this.mAdapter.registerDataSetObserver(new ActivityChooserView_4());
