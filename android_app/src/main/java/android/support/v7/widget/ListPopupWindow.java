...
public class ListPopupWindow {
    ...
    class ListPopupWindow_2 implements Runnable {
        ListPopupWindow_2() {
        }
    ...
    class ListPopupWindow_3 implements OnItemSelectedListener {
        ListPopupWindow_3() {
        }
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mShowDropDownRunnable = new ListPopupWindow_2();
            ...
            this.mDropDownList.setOnItemSelectedListener(new ListPopupWindow_3());
