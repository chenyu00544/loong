...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    private class DropdownPopup extends ListPopupWindow {
        ...
        class AppCompatSpinner_DropdownPopup_2 implements OnGlobalLayoutListener {
            AppCompatSpinner_DropdownPopup_2() {
            }
        ...
        public void show() {
            ...
            if (!isShowing) {
                ...
                if (viewTreeObserver != null) {
                    final OnGlobalLayoutListener appCompatSpinner_DropdownPopup_2 = new AppCompatSpinner_DropdownPopup_2();
                    viewTreeObserver.addOnGlobalLayoutListener(appCompatSpinner_DropdownPopup_2);
                    setOnDismissListener(new OnDismissListener() {
                        public void onDismiss() {
                            ViewTreeObserver viewTreeObserver = AppCompatSpinner.this.getViewTreeObserver();
                            if (viewTreeObserver != null) {
                                viewTreeObserver.removeGlobalOnLayoutListener(appCompatSpinner_DropdownPopup_2);
                            }
                        }
                    });
                }
