        ...
        while (i10 < virtualChildCount) {
            ...
            if (virtualChildAt == null) {
                ...
                if (z) {
                    ...
                    if (i6 != -1) {
                        int i15 = ((((layoutParams2.gravity < 0 ? this.mGravity : layoutParams2.gravity) & g.if) >> 4) & -2) >> 1;
            ...
            while (i9 < virtualChildCount) {
                ...
                if (virtualChildAt3 == null) {
                    ...
                    if (z) {
                        ...
                        if (i12 != -1) {
                            i3 = ((((layoutParams.gravity < 0 ? this.mGravity : layoutParams.gravity) & g.if) >> 4) & -2) >> 1;
