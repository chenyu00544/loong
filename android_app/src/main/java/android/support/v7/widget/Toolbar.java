...
public class Toolbar extends ViewGroup {
    ...
    class Toolbar_1 implements android.support.v7.widget.ActionMenuView.OnMenuItemClickListener {
        Toolbar_1() {
        }
    ...
    class Toolbar_2 implements Runnable {
        Toolbar_2() {
        }
    ...
    class Toolbar_3 implements OnClickListener {
        Toolbar_3() {
        }
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menuBuilder, MenuItemImpl menuItemImpl) {
            ...
            if (Toolbar.this.mExpandedActionView.getParent() != Toolbar.this) {
                ...
                generateDefaultLayoutParams.gravity = GravityCompat.START | (Toolbar.this.mButtonGravity & g.if);
    ...
    public static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new Toolbar_SavedState_1();
        int expandedMenuItemId;
        boolean isOverflowOpen;

        static class Toolbar_SavedState_1 implements Creator<SavedState> {
            Toolbar_SavedState_1() {
            }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mMenuViewItemClickListener = new Toolbar_1();
        this.mShowOverflowMenuRunnable = new Toolbar_2();
    ...
    private void ensureMenuView() {
        if (this.mMenuView == null) {
            ...
            generateDefaultLayoutParams.gravity = GravityCompat.END | (this.mButtonGravity & g.if);
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            ...
            android.view.ViewGroup.LayoutParams generateDefaultLayoutParams = generateDefaultLayoutParams();
            generateDefaultLayoutParams.gravity = GravityCompat.START | (this.mButtonGravity & g.if);
    ...
    private void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            ...
            this.mCollapseButtonView.setOnClickListener(new Toolbar_3());
        }
    }
