...
public class LinearLayoutManager extends LayoutManager implements ViewDropHandler {
    ...
    public static class SavedState implements Parcelable {
        public static final Creator<SavedState> CREATOR = new LinearLayoutManager_SavedState_1();
        boolean mAnchorLayoutFromEnd;
        int mAnchorOffset;
        int mAnchorPosition;

        static class LinearLayoutManager_SavedState_1 implements Creator<SavedState> {
            LinearLayoutManager_SavedState_1() {
            }
    ...
    public void smoothScrollToPosition(RecyclerView recyclerView, State state, int i) {
        SmoothScroller linearLayoutManager_1 = new LinearSmoothScroller(recyclerView.getContext()) {
            public PointF computeScrollVectorForPosition(int i) {
                return LinearLayoutManager.this.computeScrollVectorForPosition(i);
            }
        };
        linearLayoutManager_1.setTargetPosition(i);
        startSmoothScroll(linearLayoutManager_1);
    }
