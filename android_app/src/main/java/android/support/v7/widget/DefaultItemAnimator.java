...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public void runPendingAnimations() {
        ...
        if (i4 != 0 || i != 0 || i3 != 0 || i2 != 0) {
            ...
            Runnable defaultItemAnimator_1;
            ...
            if (i != 0) {
                ...
                defaultItemAnimator_1 = new Runnable() {
                    public void run() {
                ...
                if (i4 != 0) {
                    ViewCompat.postOnAnimationDelayed(((MoveInfo) arrayList.get(0)).holder.itemView, defaultItemAnimator_1, getRemoveDuration());
                } else {
                    defaultItemAnimator_1.run();
                }
            }
            if (i2 != 0) {
                arrayList = new ArrayList();
                ...
                if (i4 != 0) {
                    ViewCompat.postOnAnimationDelayed(((ChangeInfo) arrayList.get(0)).oldHolder.itemView, defaultItemAnimator_1, getRemoveDuration());
                } else {
                    defaultItemAnimator_1.run();
                }
            }
            if (i3 != 0) {
                ...
                Runnable defaultItemAnimator_3 = new Runnable() {
                    public void run() {
                ...
                ViewCompat.postOnAnimationDelayed(((ViewHolder) arrayList2.get(0)).itemView, defaultItemAnimator_3, removeDuration + Math.max(moveDuration, changeDuration));
            }
        }
    }
