...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class SearchView_10 implements OnItemClickListener {
        SearchView_10() {
        }
    ...
    class SearchView_11 implements OnItemSelectedListener {
        SearchView_11() {
        }
    ...
    class SearchView_12 implements TextWatcher {
        SearchView_12() {
        }
    ...
    class SearchView_1 implements Runnable {
        SearchView_1() {
        }
    ...
    class SearchView_2 implements Runnable {
        SearchView_2() {
        }
    ...
    class SearchView_3 implements Runnable {
        SearchView_3() {
        }
    ...
    class SearchView_4 implements OnFocusChangeListener {
        SearchView_4() {
        }
    ...
    class SearchView_5 implements OnLayoutChangeListener {
        SearchView_5() {
        }
    ...
    class SearchView_6 implements OnGlobalLayoutListener {
        SearchView_6() {
        }
    ...
    class SearchView_7 implements OnClickListener {
        SearchView_7() {
        }
    ...
    class SearchView_8 implements OnKeyListener {
        SearchView_8() {
        }
    ...
    class SearchView_9 implements OnEditorActionListener {
        SearchView_9() {
        }
    ...
    static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new SearchView_SavedState_1();
        boolean isIconified;

        static class SearchView_SavedState_1 implements Creator<SavedState> {
            SearchView_SavedState_1() {
            }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        this.mShowImeRunnable = new SearchView_1();
        this.mUpdateDrawableStateRunnable = new SearchView_2();
        this.mReleaseCursorRunnable = new SearchView_3();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new SearchView_7();
        this.mTextKeyListener = new SearchView_8();
        this.mOnEditorActionListener = new SearchView_9();
        this.mOnItemClickListener = new SearchView_10();
        this.mOnItemSelectedListener = new SearchView_11();
        this.mTextWatcher = new SearchView_12();
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new SearchView_4());
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new SearchView_5());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new SearchView_6());
    }
