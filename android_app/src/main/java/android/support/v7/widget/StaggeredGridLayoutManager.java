...
public class StaggeredGridLayoutManager extends LayoutManager {
    ...
    private final Runnable mCheckForGapsRunnable = new StaggeredGridLayoutManager_1();
    ...
    class StaggeredGridLayoutManager_1 implements Runnable {
        StaggeredGridLayoutManager_1() {
        }
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            public static final Creator<FullSpanItem> CREATOR = new StaggeredGridLayoutManager_LazySpanLookup_FullSpanItem_1();
            int mGapDir;
            int[] mGapPerSpan;
            boolean mHasUnwantedGapAfter;
            int mPosition;

            static class StaggeredGridLayoutManager_LazySpanLookup_FullSpanItem_1 implements Creator<FullSpanItem> {
                StaggeredGridLayoutManager_LazySpanLookup_FullSpanItem_1() {
                }
    ...
    public static class SavedState implements Parcelable {
        public static final Creator<SavedState> CREATOR = new StaggeredGridLayoutManager_SavedState_1();
        ...
        static class StaggeredGridLayoutManager_SavedState_1 implements Creator<SavedState> {
            StaggeredGridLayoutManager_SavedState_1() {
            }
    ...
    public void smoothScrollToPosition(RecyclerView recyclerView, State state, int i) {
        SmoothScroller staggeredGridLayoutManager_2 = new LinearSmoothScroller(recyclerView.getContext()) {
        ...
        staggeredGridLayoutManager_2.setTargetPosition(i);
        startSmoothScroll(staggeredGridLayoutManager_2);
    }
