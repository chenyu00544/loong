...
public class ActionBarOverlayLayout extends ViewGroup implements NestedScrollingParent, DecorContentParent {
    ...
    class ActionBarOverlayLayout_1 extends ViewPropertyAnimatorListenerAdapter {
        ActionBarOverlayLayout_1() {
        }
    ...
    class ActionBarOverlayLayout_2 implements Runnable {
        ActionBarOverlayLayout_2() {
        }
    ...
    class ActionBarOverlayLayout_3 implements Runnable {
        ActionBarOverlayLayout_3() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mTopAnimatorListener = new ActionBarOverlayLayout_1();
        this.mRemoveActionBarHideOffset = new ActionBarOverlayLayout_2();
        this.mAddActionBarHideOffset = new ActionBarOverlayLayout_3();
        init(context);
