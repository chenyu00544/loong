...
class ActionMenuPresenter extends BaseMenuPresenter implements SubUiVisibilityListener {
    ...
    private static class SavedState implements Parcelable {
        public static final Creator<SavedState> CREATOR = new ActionMenuPresenter_SavedState_1();
        public int openSubMenuId;

        static class ActionMenuPresenter_SavedState_1 implements Creator<SavedState> {
            ActionMenuPresenter_SavedState_1() {
            }
