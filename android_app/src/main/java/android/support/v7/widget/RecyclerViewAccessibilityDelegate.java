...
public class RecyclerViewAccessibilityDelegate extends AccessibilityDelegateCompat {
    final AccessibilityDelegateCompat mItemDelegate = new RecyclerViewAccessibilityDelegate_1();
    final RecyclerView mRecyclerView;

    class RecyclerViewAccessibilityDelegate_1 extends AccessibilityDelegateCompat {
        RecyclerViewAccessibilityDelegate_1() {
        }
