...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new WindowDecorActionBar_1();
    ...
    final ViewPropertyAnimatorListener mShowListener = new WindowDecorActionBar_2();
    private boolean mShowingForMode;
    private ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new WindowDecorActionBar_3();

    class WindowDecorActionBar_1 extends ViewPropertyAnimatorListenerAdapter {
        WindowDecorActionBar_1() {
        }
    ...
    class WindowDecorActionBar_2 extends ViewPropertyAnimatorListenerAdapter {
        WindowDecorActionBar_2() {
        }
    ...
    class WindowDecorActionBar_3 implements ViewPropertyAnimatorUpdateListener {
        WindowDecorActionBar_3() {
        }
