...
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase implements LayoutInflaterFactory, Callback {
    ...
    private final Runnable mInvalidatePanelMenuRunnable = new AppCompatDelegateImplV7_1();
    ...
    class AppCompatDelegateImplV7_1 implements Runnable {
        AppCompatDelegateImplV7_1() {
        }
    ...
    class AppCompatDelegateImplV7_2 implements OnApplyWindowInsetsListener {
        AppCompatDelegateImplV7_2() {
        }
    ...
    class AppCompatDelegateImplV7_3 implements OnFitSystemWindowsListener {
        AppCompatDelegateImplV7_3() {
        }
    ...
    class AppCompatDelegateImplV7_4 implements OnAttachListener {
        AppCompatDelegateImplV7_4() {
        }
    ...
    class AppCompatDelegateImplV7_5 implements Runnable {

        class AppCompatDelegateImplV7_5_1 extends ViewPropertyAnimatorListenerAdapter {
            AppCompatDelegateImplV7_5_1() {
            }
        ...
        public void run() {
            ...
            AppCompatDelegateImplV7.this.mFadeAnim.setListener(new AppCompatDelegateImplV7_5_1());
        }
    }

    class AppCompatDelegateImplV7_6 extends ViewPropertyAnimatorListenerAdapter {
        AppCompatDelegateImplV7_6() {
        }
    ...
    class ActionModeCallbackWrapperV7 implements ActionMode.Callback {
        ...
        class AppCompatDelegateImplV7_ActionModeCallbackWrapperV7_1 extends ViewPropertyAnimatorListenerAdapter {
            AppCompatDelegateImplV7_ActionModeCallbackWrapperV7_1() {
            }
        ...
        public void onDestroyActionMode(ActionMode actionMode) {
            ...
            if (AppCompatDelegateImplV7.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV7.this.mFadeAnim.setListener(new AppCompatDelegateImplV7_ActionModeCallbackWrapperV7_1());
            }
    ...
    private static final class PanelFeatureState {
        ...
        private static class SavedState implements Parcelable {
            public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new AppCompatDelegateImplV7_PanelFeatureState_SavedState_1());
            int featureId;
            boolean isOpen;
            Bundle menuState;

            static class AppCompatDelegateImplV7_PanelFeatureState_SavedState_1 implements ParcelableCompatCreatorCallbacks<SavedState> {
                AppCompatDelegateImplV7_PanelFeatureState_SavedState_1() {
                }
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                ...
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(view2, new AppCompatDelegateImplV7_2());
                    view = view2;
                } else {
                    ((FitWindowsViewGroup) view2).setOnFitSystemWindowsListener(new AppCompatDelegateImplV7_3());
                    view = view2;
                }
            ...
            contentFrameLayout.setAttachListener(new AppCompatDelegateImplV7_4());
            return view;
        }
        obtainStyledAttributes.recycle();
        ...
        if (actionMode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    this.mShowActionModePopup = new AppCompatDelegateImplV7_5();
                } else {
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(standaloneActionMode, standaloneActionMode.getMenu())) {
                    ...
                    this.mFadeAnim.setListener(new AppCompatDelegateImplV7_6());
                    if (this.mActionModePopup != null) {
