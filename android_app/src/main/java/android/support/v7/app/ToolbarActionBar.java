...
class ToolbarActionBar extends ActionBar {
    ...
    private final OnMenuItemClickListener mMenuClicker = new ToolbarActionBar_2();
    private final Runnable mMenuInvalidator = new ToolbarActionBar_1();
    private ArrayList<OnMenuVisibilityListener> mMenuVisibilityListeners = new ArrayList();
    private boolean mToolbarMenuPrepared;
    private Callback mWindowCallback;

    class ToolbarActionBar_1 implements Runnable {
        ToolbarActionBar_1() {
        }
    ...
    class ToolbarActionBar_2 implements OnMenuItemClickListener {
        ToolbarActionBar_2() {
        }
