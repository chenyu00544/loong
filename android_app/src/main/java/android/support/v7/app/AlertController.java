...
class AlertController {
    ...
    private final OnClickListener mButtonHandler = new AlertController_1();
    ...
    class AlertController_1 implements OnClickListener {
        AlertController_1() {
        }
    ...
    public static class AlertParams {
        ...
        private void createListView(final AlertController alertController) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                Object alertController_AlertParams_2 = new CursorAdapter(this.mContext, this.mCursor, false) {
