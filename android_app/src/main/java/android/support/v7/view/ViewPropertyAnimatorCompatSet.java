...
public class ViewPropertyAnimatorCompatSet {
    ...
    private final ViewPropertyAnimatorListenerAdapter mProxyListener = new ViewPropertyAnimatorCompatSet_1();

    class ViewPropertyAnimatorCompatSet_1 extends ViewPropertyAnimatorListenerAdapter {
        private int mProxyEndCount = 0;
        private boolean mProxyStarted = false;

        ViewPropertyAnimatorCompatSet_1() {
        }
