...
public class AsyncListUtil<T> {
    ...
    private final BackgroundCallback<T> mBackgroundCallback = new AsyncListUtil_2();
    final BackgroundCallback<T> mBackgroundProxy;
    final DataCallback<T> mDataCallback;
    int mDisplayedGeneration = 0;
    private int mItemCount = 0;
    private final MainThreadCallback<T> mMainThreadCallback = new AsyncListUtil_1();
    ...
    class AsyncListUtil_1 implements MainThreadCallback<T> {
        AsyncListUtil_1() {
        }
    ...
    class AsyncListUtil_2 implements BackgroundCallback<T> {
