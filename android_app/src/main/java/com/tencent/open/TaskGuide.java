...
public class TaskGuide extends BaseApi {
    private static int L = b.REQUEST_MERGE_PERIOD;
    static long b = com.baidu.location.h.e.kg;
    ...
    /* compiled from: ProGuard */
    class TaskGuide_2 implements Runnable {
        final /* synthetic */ TaskGuide a;

        TaskGuide_2(TaskGuide taskGuide) {
            this.a = taskGuide;
        }
        ...
        public void onComplete(JSONObject jSONObject) {
            ...
            try {
                ...
                if (i == 0) {
                    ...
                    this.c.b(this.b);
                    this.c.d((int) m_AppUI.MSG_APP_DATA_OK);
                }
            ...
            if (this.c.g != null) {
                this.c.g.post(new Runnable(this) {
                    ...
                    public void run() {
                        ...
                        this.b.c.b(this.b.b);
                        this.b.c.d((int) m_AppUI.MSG_APP_DATA_OK);
                    }
                });
            }
        }
    ...
    private class e extends RelativeLayout {
        ...
        public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
            ...
            this.b.d((int) b.REQUEST_MERGE_PERIOD);
    ...
    private static class h {
        ...
        static h a(JSONObject jSONObject) throws JSONException {
            ...
            hVar.a = jSONObject2.getString(AgooConstants.MESSAGE_TASK_ID);
    ...
    private class j extends a {
        ...
        /* compiled from: ProGuard */
        class TaskGuide_j_1 implements Runnable {
            final /* synthetic */ j a;

            TaskGuide_j_1(j jVar) {
                this.a = jVar;
            }
        ...
        protected void a(Exception exception) {
            ...
            this.b.g.post(new TaskGuide_j_1(this));
        }
    }
    ...
    public void showWindow() {
        new Handler(Looper.getMainLooper()).post(new TaskGuide_2(this));
    ...
    private void e(int i) {
        ...
        composeCGIParams.putString(AgooConstants.MESSAGE_TASK_ID, this.h.a);
