            ...
            this.h.execute(new Runnable(this) {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        bundle.putString(b.JSON_ERRORCODE, i2 + "");
    ...
    public void a(String str, String str2, Bundle bundle, boolean z) {
        ...
        ThreadManager.executeOnSubThread(new Runnable(this) {
            ...
            public void run() {
                ...
                int a = e.a();
                int i = a == 0 ? 3 : a;
                f.b("openSDK_LOG.ReportManager", "-->httpRequest, retryCount: " + i);
