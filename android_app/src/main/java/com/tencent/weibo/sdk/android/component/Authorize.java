...
public class Authorize extends Activity {
    ...
    Handler handle = new Authorize_1();
    ...
    class Authorize_1 extends Handler {
        Authorize_1() {
        }
    ...
    class Authorize_2 implements OnClickListener {
        Authorize_2() {
        }
    ...
    class Authorize_3 extends WebChromeClient {
        Authorize_3() {
        }
    ...
    class Authorize_4 extends WebViewClient {
        Authorize_4() {
        }
    ...
    class Authorize_5 implements DialogInterface.OnClickListener {
        Authorize_5() {
        }
    ...
    class Authorize_6 implements DialogInterface.OnClickListener {
        Authorize_6() {
        }
    ...
    public void initLayout() {
        ...
        button.setOnClickListener(new Authorize_2());
        ...
        this.webView.setWebChromeClient(new Authorize_3());
        this.webView.setWebViewClient(new Authorize_4());
    ...
    protected Dialog onCreateDialog(int i) {
        switch (i) {
            ...
            case 4:
                ...
                builder.setPositiveButton("是", new Authorize_5());
                builder.setNegativeButton("否", new Authorize_6());
