...
public class FriendActivity extends Activity implements OnTouchingLetterChangedListener, HttpCallback {
    ...
    class FriendActivity_1 implements OnClickListener {
        FriendActivity_1() {
        }
    ...
    class FriendActivity_2 implements TextWatcher {
        FriendActivity_2() {
        }
    ...
    class FriendActivity_3 implements OnGroupExpandListener {
        FriendActivity_3() {
        }
    ...
    class FriendActivity_4 implements OnGroupClickListener {
        FriendActivity_4() {
        }
    ...
    private View initview() {
        ...
        button.setOnClickListener(new FriendActivity_1());
        ...
        this.editText.addTextChangedListener(new FriendActivity_2());
    ...
    private void ex(final List<String> list, final Map<String, List<Firend>> map) {
        ...
        this.listView.setOnGroupExpandListener(new FriendActivity_3());
        this.listView.setOnGroupClickListener(new FriendActivity_4());
