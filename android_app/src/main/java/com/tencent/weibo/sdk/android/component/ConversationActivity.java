...
public class ConversationActivity extends Activity implements HttpCallback {
    ...
    class ConversationActivity_1 implements OnItemClickListener {
        ConversationActivity_1() {
        }
    ...
    class ConversationActivity_2 implements TextWatcher {
        ConversationActivity_2() {
        }
    ...
    class ConversationActivity_3 implements OnClickListener {
        ConversationActivity_3() {
        }
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.listView.setOnItemClickListener(new ConversationActivity_1());
        if (this.dialog == null) {
    ...
    private View initview() {
        ...
        this.editText.addTextChangedListener(new ConversationActivity_2());
        ...
        button.setOnClickListener(new ConversationActivity_3());
    ...
    private List<String> initData(JSONObject jSONObject) {
        ...
        try {
            ...
            for (int i = 0; i < jSONArray.length(); i++) {
                arrayList.add("#" + jSONArray.getJSONObject(i).getString(WeiXinShareContent.TYPE_TEXT) + "#");
            }
