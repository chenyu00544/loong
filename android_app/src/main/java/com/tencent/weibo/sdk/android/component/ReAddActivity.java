...
public class ReAddActivity extends Activity {
    ...
    private HttpCallback mCallBack = new ReAddActivity_1();
    ...
    private HttpCallback videoCallBack = new ReAddActivity_2();
    private String videoPath = "";

    class ReAddActivity_1 implements HttpCallback {
        ReAddActivity_1() {
        }
    ...
    class ReAddActivity_2 implements HttpCallback {
        ReAddActivity_2() {
        }
    ...
    class ReAddActivity_3 implements OnClickListener {
        ReAddActivity_3() {
        }
    ...
    class ReAddActivity_4 implements OnClickListener {
        ReAddActivity_4() {
        }
    ...
    class ReAddActivity_5 implements TextWatcher {
    ...
    public View initLayout() {
        ...
        button.setOnClickListener(new ReAddActivity_3());
        ...
        layoutParams3.bottomMargin = 10;
        button.setLayoutParams(layoutParams3);
        button.setOnClickListener(new ReAddActivity_4());
        relativeLayout.addView(button);
        ...
        this.content.addTextChangedListener(new ReAddActivity_5());
        ...
        layoutParams2 = new RelativeLayout.LayoutParams(ErrorCode.DM_APPKEY_INVALID, g.a);
