...
public class GeneralInterfaceActivity extends Activity implements OnClickListener {
    ...
    class GeneralInterfaceActivity_1 implements HttpCallback {
        GeneralInterfaceActivity_1() {
        }
    ...
    class GeneralInterfaceActivity_2 implements IdleHandler {
        GeneralInterfaceActivity_2() {
        }
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.mCallBack = new GeneralInterfaceActivity_1();
    ...
    public void initInterface() {
        ...
        this.errorReport.setId(m_AppUI.MSG_GET_GL_OK);
    ...
    public void onClick(View view) {
        Looper.myQueue().addIdleHandler(new GeneralInterfaceActivity_2());
        switch (view.getId()) {
            case 1001:
