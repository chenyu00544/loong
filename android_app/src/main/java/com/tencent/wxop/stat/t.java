...
*/
    ...
    private synchronized void a(ah ahVar) {
        ...
        try {
            ...
            if (1 == obj) {
                update = (long) this.bW.getWritableDatabase().update("config", contentValues, "type=?", new String[]{Integer.toString(ahVar.aI)});
            } else {
            ...
            try {
                ...
                try {
                    ...
                    if (obj == null) {
                        ...
                        contentValues2.put("uid", r.q(str2));
