...
public abstract class BaseApi {
    ...
    protected Bundle composeCGIParams() {
        ...
        if (isOEM) {
            bundle.putString(Constants.PARAM_PLATFORM_ID, "desktop_m_qq-" + installChannel + SocializeConstants.OP_DIVIDER_MINUS + "android" + SocializeConstants.OP_DIVIDER_MINUS + registerChannel + SocializeConstants.OP_DIVIDER_MINUS + businessId);
        } else {
