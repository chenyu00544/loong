...
public class AuthDialog extends Dialog {
    ...
    /* compiled from: ProGuard */
    class AuthDialog_1 implements OnLongClickListener {
        final /* synthetic */ AuthDialog a;

        AuthDialog_1(AuthDialog authDialog) {
            this.a = authDialog;
        }
    ...
    /* compiled from: ProGuard */
    class AuthDialog_2 implements OnTouchListener {
        final /* synthetic */ AuthDialog a;

        AuthDialog_2(AuthDialog authDialog) {
            this.a = authDialog;
        }
    ...
    /* compiled from: ProGuard */
    class AuthDialog_3 implements OnDismissListener {
        final /* synthetic */ AuthDialog a;

        AuthDialog_3(AuthDialog authDialog) {
            this.a = authDialog;
        }
    ...
    private class LoginWebViewClient extends WebViewClient {
        ...
        /* compiled from: ProGuard */
        class AuthDialog_LoginWebViewClient_1 implements Runnable {
            final /* synthetic */ LoginWebViewClient a;

            AuthDialog_LoginWebViewClient_1(LoginWebViewClient loginWebViewClient) {
                this.a = loginWebViewClient;
            }
        ...
        public void onReceivedError(WebView webView, int i, String str, String str2) {
            ...
            if (!Util.checkNetWork(this.a.k)) {
                this.a.b.onError(new UiError(m_AppUI.MSG_CLICK_ITEM, "当前网络不可用，请稍后重试！", str2));
                this.a.dismiss();
                ...
                this.a.n = this.a.n + 1;
                this.a.d.postDelayed(new AuthDialog_LoginWebViewClient_1(this), 500);
            }
        }
    ...
    private void d() {
        ...
        this.j.setOnLongClickListener(new AuthDialog_1(this));
        this.j.setOnTouchListener(new AuthDialog_2(this));
        ...
        super.setOnDismissListener(new AuthDialog_3(this));
    }
