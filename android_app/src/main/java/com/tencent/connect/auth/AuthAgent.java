...
public class AuthAgent extends BaseApi {
    ...
    private class FeedConfirmListener implements IUiListener {
        ...
        private void a(String str, final IUiListener iUiListener, final Object obj) {
            ...
            if (activity != null) {
                ...
                OnClickListener authAgent_FeedConfirmListener_1 = new ButtonListener(this, dialog) {
                ...
                OnClickListener authAgent_FeedConfirmListener_2 = new ButtonListener(this, dialog) {
                    final /* synthetic */ FeedConfirmListener c;
                ...
                dialog.setContentView(a(activity, drawable, str, authAgent_FeedConfirmListener_1, authAgent_FeedConfirmListener_2));
    ...
    private int a(boolean z, IUiListener iUiListener) {
        ...
        if (isOEM) {
            composeCGIParams.putString(Constants.PARAM_PLATFORM_ID, "desktop_m_qq-" + installChannel + SocializeConstants.OP_DIVIDER_MINUS + c.ANDROID + SocializeConstants.OP_DIVIDER_MINUS + registerChannel + SocializeConstants.OP_DIVIDER_MINUS + businessId);
        } else {
