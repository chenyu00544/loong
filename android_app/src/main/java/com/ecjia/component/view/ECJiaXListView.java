...
@TargetApi(9)
public class ECJiaXListView extends ListView implements OnScrollListener {
    ...
    class ECJiaXListView_1 implements OnGlobalLayoutListener {
        final /* synthetic */ ECJiaXListView a;

        ECJiaXListView_1(ECJiaXListView eCJiaXListView) {
            this.a = eCJiaXListView;
        }
    ...
    class ECJiaXListView_2 implements OnClickListener {
        final /* synthetic */ ECJiaXListView a;

        ECJiaXListView_2(ECJiaXListView eCJiaXListView) {
            this.a = eCJiaXListView;
        }
    ...
    class ECJiaXListView_3 implements OnClickListener {
        final /* synthetic */ ECJiaXListView a;

        ECJiaXListView_3(ECJiaXListView eCJiaXListView) {
            this.a = eCJiaXListView;
        }
    ...
    class ECJiaXListView_4 extends Handler {
        final /* synthetic */ ECJiaXListView a;

        ECJiaXListView_4(ECJiaXListView eCJiaXListView) {
            this.a = eCJiaXListView;
        }
    ...
    class ECJiaXListView_5 extends Handler {
        final /* synthetic */ ECJiaXListView a;

        ECJiaXListView_5(ECJiaXListView eCJiaXListView) {
            this.a = eCJiaXListView;
        }
    ...
    public ECJiaXListView(Context context) {
        super(context);
        setOverScrollMode(2);
        initWithContext(context);
    }

    public ECJiaXListView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        setOverScrollMode(2);
        initWithContext(context);
    }

    public ECJiaXListView(Context context, AttributeSet attributeSet, int i) {
    ...
    private void initWithContext(Context context) {
        ...
        this.mHeaderView.getViewTreeObserver().addOnGlobalLayoutListener(new ECJiaXListView_1(this));
    }
    ...
    public void setPullLoadEnable(boolean z) {
        ...
        if (this.mEnablePullLoad) {
            ...
            this.mFooterView.setOnClickListener(new ECJiaXListView_2(this));
            return;
        }
    ...
    public void setPullLoadEnable(boolean z, boolean z2) {
        ...
        if (this.mEnablePullLoad) {
            ...
            this.mFooterView.setState(0);
            this.mFooterView.setOnClickListener(new ECJiaXListView_3(this));
            return;
        }
        this.mFooterView.hide();
        this.mFooterView.setOnClickListener(null);
    ...
    public void startLoadMore() {
        ...
        new ECJiaXListView_4(this).sendEmptyMessageDelayed(0, 4000);
    }
            ...
            default:
                ...
                if (this.mEnablePullRefresh && this.mHeaderView.getVisiableHeight() > this.mHeaderViewHeight) {
                    ...
                    if (this.mListViewListener != null) {
                        ...
                        new ECJiaXListView_5(this).sendEmptyMessageDelayed(0, 4000);
                    }
                }
                resetHeaderHeight();
                break;
