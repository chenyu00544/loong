...
public class ECJiaLeftSlidingListView extends ECJiaXListView {
    ...
    class a extends Handler {
        ...
        int c;
        View d;
        final /* synthetic */ ECJiaLeftSlidingListView e;
        private boolean f = false;

        a(ECJiaLeftSlidingListView eCJiaLeftSlidingListView) {
            this.e = eCJiaLeftSlidingListView;
        }
    ...
    public ECJiaLeftSlidingListView(Context context) {
        this(context, null);
    }

    public ECJiaLeftSlidingListView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public ECJiaLeftSlidingListView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mRightViewWidth = (int) obtainStyledAttributes.getDimension(0, b.a(getContext()).getDimension(R.dimen.leftsliding_right));
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        switch (motionEvent.getAction()) {
            case 0:
                ...
                this.realPosition = pointToPosition;
        ...
        switch (motionEvent.getAction()) {
            ...
            case 2:
                ...
                if (this.mIsHorizontal != null || judgeScrollDirection(x, y)) {
                    ...
                    if (x >= 0.0f || x <= ((float) (-this.mRightViewWidth)) || isleftsliding || needReturn(this.mCurrentItemView)) {
                        return true;
                    }
    ...
    public void hiddenRight(View view) {
        if (this.mCurrentItemView != null && !needReturn(view)) {
            Message obtainMessage = new a(this).obtainMessage();
            obtainMessage.obj = view;
            obtainMessage.arg1 = view.getScrollX();
    ...
    private boolean needReturn(View view) {
        return view == null || this.realPosition < 0;
    }
}
