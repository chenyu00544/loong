...
/* compiled from: ECJiaShopListAdapter */
public class bl extends BaseAdapter {
    ...
    public bl(Context context, ArrayList<ao> arrayList, int i) {
        this.d = context;
        this.e = arrayList;
        this.g = i;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (TextUtils.isEmpty(aoVar.j()) || "null".equals(aoVar.j())) {
            aVar.j.setText("");
        } else {
            aVar.j.setText(aoVar.j());
        }
        ...
        aVar.k.setOnClickListener(new OnClickListener(this) {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("sellerid", aoVar.e());
