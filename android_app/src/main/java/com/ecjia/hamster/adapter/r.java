...
/* compiled from: ECJiaGoodsHorizLVAdapter */
public class r extends BaseAdapter {
    ...
    public r(Context context, ArrayList<ECJia_GOODS_LIST> arrayList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        this.b.displayImage(((ECJia_GOODS_LIST) this.a.get(i)).getImg().getThumb(), aVar.a);
        return view;
    }
}
