...
public class h {
    ...
    public static boolean a(boolean z) {
        ...
        try {
            ...
            if (z) {
                str = a("accs", Constants.SP_KEY_TNET_LOG_OFF, SocializeProtocolConstants.PROTOCOL_KEY_DEFAULT);
            }
    ...
    public static String d() {
        String str = null;
        try {
            str = GlobalClientInfo.getContext().getSharedPreferences(Constants.SP_FILE_NAME, 0).getString("pullup", str);
        } catch (Throwable th) {
