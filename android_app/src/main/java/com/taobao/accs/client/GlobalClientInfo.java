...
public class GlobalClientInfo {
    ...
    private Map<String, String> m = new GlobalClientInfo_1(this);
    private Map<String, AccsAbstractDataListener> n = new ConcurrentHashMap();

    /* compiled from: Taobao */
    class GlobalClientInfo_1 extends ConcurrentHashMap<String, String> {
        final /* synthetic */ GlobalClientInfo a;

        GlobalClientInfo_1(GlobalClientInfo globalClientInfo) {
