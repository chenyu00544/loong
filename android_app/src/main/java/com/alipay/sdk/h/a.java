...
public final class a {
    ...
    public class a extends AlertDialog {
        ...
        protected final void onCreate(Bundle bundle) {
            ...
            layoutParams = new LinearLayout.LayoutParams(a(context, (float) TitleBar.BACKBTN_LEFT_MARGIN), a(context, (float) TitleBar.BACKBTN_LEFT_MARGIN));
            layoutParams.gravity = 16;
            layoutParams.setMargins(a(this.a.c, 17.0f), a(this.a.c, (float) TitleBar.SHAREBTN_RIGHT_MARGIN), a(this.a.c, 8.0f), a(this.a.c, (float) TitleBar.SHAREBTN_RIGHT_MARGIN));
        ...
        private static Drawable a(Context context, String str) {
            ...
            try {
                byteArrayInputStream = new ByteArrayInputStream(com.alipay.sdk.c.a.a(str));
                try {
