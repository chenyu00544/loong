...
public final class e {
    ...
    public final c a(b bVar, boolean z) {
        ...
        if (this.a) {
            ...
            bytes2 = com.alipay.sdk.c.e.a(this.b, bytes2);
            a = a(bytes, a2, bytes2);
        } else {
            a = a(bytes, bytes2);
        }
    ...
    public final com.alipay.sdk.e.b a(com.alipay.sdk.e.c r7) {
        /*
        r6 = this;
        r0 = 0;
    ...
    L_0x003b:
        ...
        r3 = com.alipay.sdk.c.e.b(r4, r3);	 Catch:{ Exception -> 0x007f, all -> 0x007a }
    L_0x0041:
        r4 = r7.a;	 Catch:{ Exception -> 0x007f, all -> 0x007a }
        if (r4 == 0) goto L_0x0083;
    L_0x0045:
        r3 = com.alipay.sdk.c.c.b(r3);	 Catch:{ Exception -> 0x007f, all -> 0x007a }
        r4 = r3;
    L_0x004a:
    ...
    L_0x0085:
        ...
        goto L_0x004f;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.alipay.sdk.e.e.a(com.alipay.sdk.e.c):com.alipay.sdk.e.b");
    }
