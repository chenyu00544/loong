...
public class a extends com.umeng.socialize.shareboard.b.a {
    private List<SnsPlatform> a = new ArrayList();
    private Context b;
    ...
    private void a(View view, SnsPlatform snsPlatform) {
        ((ImageView) view.findViewById(ResContainer.getResourceId(this.b, "id", "umeng_socialize_shareboard_image"))).setImageResource(ResContainer.getResourceId(this.b, "drawable", snsPlatform.mIcon));
        ((TextView) view.findViewById(ResContainer.getResourceId(this.b, "id", "umeng_socialize_shareboard_pltform_name"))).setText(ResContainer.getString(this.b, snsPlatform.mShowWord));
    }
