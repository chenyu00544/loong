...
public class bt {
        ...
        try {
            ...
            if (fileReader != null) {
                try {
                    ...
                    try {
                        bw.e(a, "Could not read from file /proc/cpuinfo", th3);
                    } catch (Throwable th32) {
                        th = th32;
                        str = str2;
                        th2 = th;
                        bw.e(a, "Could not open file /proc/cpuinfo", th2);
                        str2 = str;
                        if (str2 != null) {
                            return "";
                        }
    ...
    public static String h(Context context) {
        try {
            TelephonyManager telephonyManager = (TelephonyManager) context.getSystemService("phone");
            if (a(context, MsgConstant.PERMISSION_READ_PHONE_STATE) && telephonyManager != null) {
    ...
    public static int m(Context context) {
        try {
            ...
            bw.c(a, "error in getTimeZone", th);
        }
        return 8;
    }
    ...
    public static String[] o(Context context) {
        ...
        try {
            ...
            bw.e(a, "error in getLocaleInfo", th);
        }
        return strArr;
    }
    ...
    private static Locale B(Context context) {
        ...
        try {
            ...
            bw.c(a, "fail to read user config locale");
        }
        if (locale == null) {
    ...
    public static String p(Context context) {
        try {
            ...
            if (applicationInfo != null) {
                ...
                bw.c(a, "getAppkey failed. the applicationinfo is null!");
            }
        } catch (Throwable th) {
            bw.e(a, "Could not read UMENG_APPKEY meta-data from AndroidManifest.xml.", th);
        }
        return null;
    }
    ...
    public static String u(Context context) {
        try {
            return a(MessageDigest.getInstance(ISecurity.SIGN_ALGORITHM_MD5).digest(((X509Certificate) CertificateFactory.getInstance("X509").generateCertificate(new ByteArrayInputStream(context.getPackageManager().getPackageInfo(t(context), 64).signatures[0].toByteArray()))).getEncoded()));
        } catch (Throwable th) {
            return null;
        }
    }
