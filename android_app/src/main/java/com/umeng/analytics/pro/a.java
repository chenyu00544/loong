...
*/
    ...
    L_0x006c:
        ...
        r0 = r0.toString();	 Catch:{ SQLException -> 0x006c, all -> 0x00d5 }
        com.umeng.analytics.pro.bw.e(r0);	 Catch:{ SQLException -> 0x006c, all -> 0x00d5 }
        if (r1 == 0) goto L_0x0013;
    L_0x0089:
        r1.close();
        goto L_0x0013;
    ...
    public static boolean a(android.database.sqlite.SQLiteDatabase r4, java.util.Collection<com.umeng.analytics.pro.i> r5) {
        /* JADX: method processing error */
/*
...
*/
        ...
        r0 = c(r4, r0);	 Catch:{ SQLException -> 0x002b, all -> 0x003e }
        if (r0 <= 0) goto L_0x0010;	 Catch:{ SQLException -> 0x002b, all -> 0x003e }
    L_0x000b:
        r0 = "aggregated_cache";	 Catch:{ SQLException -> 0x002b, all -> 0x003e }
        b(r4, r0);	 Catch:{ SQLException -> 0x002b, all -> 0x003e }
    L_0x0010:
    ...
    L_0x001a:
        ...
        r0 = (com.umeng.analytics.pro.i) r0;	 Catch:{ SQLException -> 0x002b, all -> 0x003e }
        r0 = a(r0);	 Catch:{ SQLException -> 0x002b, all -> 0x003e }
    ...
    L_0x002b:
        ...
        com.umeng.analytics.pro.bw.e(r0);	 Catch:{ SQLException -> 0x002b, all -> 0x003e }
        r0 = 0;
        r4.endTransaction();
    L_0x0035:
        return r0;
    ...
    L_0x003e:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.umeng.analytics.pro.a.a(android.database.sqlite.SQLiteDatabase, java.util.Collection):boolean");
    }
...
*/
    ...
    public static boolean b(SQLiteDatabase sQLiteDatabase, String str) {
        try {
            ...
            bw.e("cleanTableData faild!" + e.toString());
            return false;
        }
    }
    ...
    public static boolean a(f fVar, SQLiteDatabase sQLiteDatabase, Collection<i> collection) {
        try {
            ...
            bw.e("insert to Aggregated cache table faild!");
            return false;
        } finally {
    ...
    public static boolean a(SQLiteDatabase sQLiteDatabase, f fVar) {
        try {
            ...
            bw.e("cacheToAggregatedTable happen " + e.toString());
        } finally {
            sQLiteDatabase.endTransaction();
        }
    }
    ...
    public static boolean b(SQLiteDatabase sQLiteDatabase, f fVar) {
        ...
        try {
            ...
            fVar.a(Boolean.valueOf(false), false);
            bw.e("cacheToMemory happen " + e.toString());
            return false;
        } finally {
            if (cursor != null) {
                cursor.close();
    ...
    public static void a(f fVar, SQLiteDatabase sQLiteDatabase, List<String> list) {
        try {
            ...
            bw.e("insertToLimitCKTable error " + e.toString());
        } finally {
            sQLiteDatabase.endTransaction();
        }
    }
        ...
        try {
            ...
            if (c(sQLiteDatabase, com.umeng.analytics.pro.d.a.b) <= 0) {
                ...
                try {
                    ...
                    try {
                        bw.e("queryLastTimeWindowNumFromCache error " + sQLException2.toString());
                        if (rawQuery != null) {
                            rawQuery.close();
                        }
                        sQLiteDatabase.endTransaction();
        ...
        try {
            if (c(sQLiteDatabase, com.umeng.analytics.pro.d.a.a) > 0) {
                ...
                try {
                    ...
                    e = e3;
                    try {
                        bw.e("readAllAggregatedDataForUpload error " + e.toString());
                        if (rawQuery != null) {
                            rawQuery.close();
                        }
                        return cursor;
    ...
    public static JSONObject a(f fVar, SQLiteDatabase sQLiteDatabase) {
        ...
        try {
            ...
            try {
                fVar.a("faild", false);
                bw.e("readAllSystemDataForUpload error " + sQLException.toString());
                if (cursor == null) {
                    return null;
                }
                cursor.close();
        ...
        try {
            if (c(sQLiteDatabase, b.a) > 0) {
                ...
                try {
                    ...
                    e = e2;
                    try {
                        bw.e("loadLimitCKFromDB error " + e.toString());
                        if (rawQuery != null) {
                            rawQuery.close();
                        }
                        return cursor;
