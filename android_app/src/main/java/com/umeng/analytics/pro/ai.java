...
public class ai extends y {
    ...
    public boolean h() {
        ...
        if (!TextUtils.isEmpty(this.d)) {
            this.d = br.c(this.d);
            Object b = bu.b(new File("/sdcard/Android/data/.um/sysid.dat"));
            Object b2 = bu.b(new File("/sdcard/Android/obj/.um/sysid.dat"));
            Object b3 = bu.b(new File("/data/local/tmp/.um/sysid.dat"));
