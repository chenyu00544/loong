...
public class CanvasTransformerBuilder {
    private static Interpolator lin = new CanvasTransformerBuilder_1();
    private CanvasTransformer mTrans;

    static class CanvasTransformerBuilder_1 implements Interpolator {
        CanvasTransformerBuilder_1() {
        }
    ...
    class CanvasTransformerBuilder_2 implements CanvasTransformer {
        CanvasTransformerBuilder_2() {
        }
    ...
    private void initTransformer() {
        if (this.mTrans == null) {
            this.mTrans = new CanvasTransformerBuilder_2();
        }
    }
