...
public class AttentionComponentView extends FrameLayout {
    ...
    class AttentionComponentView_1 implements OnClickListener {
        AttentionComponentView_1() {
        }
    ...
    class AttentionComponentView_2 implements RequestListener {
        AttentionComponentView_2() {
        }
    ...
    class AttentionComponentView_3 implements WidgetRequestCallback {
        AttentionComponentView_3() {
        }
    ...
    private void init(Context context) {
        ...
        this.flButton.setOnClickListener(new AttentionComponentView_1());
    ...
    private void loadAttentionState(RequestParam requestParam) {
        if (!this.mIsLoadingState) {
            ...
            NetUtils.internalHttpRequest(getContext(), FRIENDSHIPS_SHOW_URL, weiboParameters, "GET", new AttentionComponentView_2());
        }
    }
    ...
    private void execAttented() {
        ...
        widgetRequestParam.setWidgetRequestCallback(new AttentionComponentView_3());
