...
public class SelectCountryActivity extends Activity implements OnIndexChangeListener {
    ...
    class SelectCountryActivity_1 implements ListenerOnTitleBtnClicked {
        SelectCountryActivity_1() {
        }
    ...
    class SelectCountryActivity_2 implements OnItemClickListener {
        SelectCountryActivity_2() {
        }
    ...
    private void initView() {
        ...
        titleBar.setTitleBarClickListener(new SelectCountryActivity_1());
        ...
        this.mListView.setOnItemClickListener(new SelectCountryActivity_2());
