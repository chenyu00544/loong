...
public final class WeiboPageUtilsV2 {
    ...
    public static void openInWeiboBrowser(Context context, String str, String str2, String str3, String str4) throws WeiboNotInstalledException {
        ...
        } else if (TextUtils.isEmpty(str2) || "topnav".equals(str2) || SocializeProtocolConstants.PROTOCOL_KEY_DEFAULT.equals(str2) || "fullscreen".equals(str2)) {
    ...
    public static void displayInWeiboMap(Context context, HashMap<String, String> hashMap) throws WeiboNotInstalledException {
        ...
        if (hashMap != null) {
            openInWeiboBrowser(context, String.format(str, new Object[]{obj2, obj, str4}), SocializeProtocolConstants.PROTOCOL_KEY_DEFAULT, (String) hashMap.get(ParamKey.EXTPARAM), str3);
        }
    }
