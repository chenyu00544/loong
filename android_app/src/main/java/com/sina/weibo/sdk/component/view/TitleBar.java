...
public class TitleBar extends RelativeLayout {
    ...
    class TitleBar_1 implements OnClickListener {
        TitleBar_1() {
        }
    ...
    private void initViews() {
        ...
        this.mLeftBtn.setOnClickListener(new TitleBar_1());
        ...
        this.mTitleText.setMaxWidth(ResourceManager.dp2px(getContext(), j.b));
