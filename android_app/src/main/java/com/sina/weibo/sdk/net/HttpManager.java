...
public class HttpManager {
    ...
    class HttpManager_1 implements RedirectHandler {
        HttpManager_1() {
        }
    ...
    class HttpManager_2 extends CustomRedirectHandler {
        HttpManager_2() {
        }
                ...
                if (str2.equals("GET")) {
                    ...
                    try {
                        ...
                        if (weiboParameters.hasBinaryData()) {
                            httpPost.setHeader(HttpRequest.HEADER_CONTENT_TYPE, "multipart/form-data; boundary=" + BOUNDARY);
                            ...
                            if (obj == null || !(obj instanceof String)) {
                                ...
                                httpPost.setHeader(HttpRequest.HEADER_CONTENT_TYPE, (String) obj);
                            }
    ...
    public static String openUrl4RdirectURL(Context context, String str, String str2, WeiboParameters weiboParameters) throws WeiboException {
        ...
        try {
            ...
            try {
                HttpUriRequest httpGet;
                defaultHttpClient.setRedirectHandler(new HttpManager_1());
                setHttpCommonParam(context, weiboParameters);
    ...
    public static String openRedirectUrl4LocationUri(Context context, String str, String str2, WeiboParameters weiboParameters) {
        ...
        HttpClient httpClient = null;
        try {
            Object httpManager_2 = new HttpManager_2();
            DefaultHttpClient defaultHttpClient = (DefaultHttpClient) getNewHttpClient();
            try {
                HttpUriRequest httpGet;
                defaultHttpClient.setRedirectHandler(httpManager_2);
                setHttpCommonParam(context, weiboParameters);
                defaultHttpClient.getParams().setParameter("http.route.default-proxy", NetStateManager.getAPN());
                if (str2.equals("GET")) {
                ...
                httpGet.setHeader(HttpRequest.HEADER_USER_AGENT, NetworkHelper.generateUA(context));
                defaultHttpClient.execute(httpGet);
                String redirectUrl = httpManager_2.getRedirectUrl();
                shutdownHttpClient(defaultHttpClient);
                return redirectUrl;
            } catch (Throwable e) {
                th = e;
    ...
    public static HttpClient getNewHttpClient() {
        try {
            ...
            schemeRegistry.register(new Scheme(HttpConstant.HTTPS, getSSLSocketFactory(), Constants.PORT));
