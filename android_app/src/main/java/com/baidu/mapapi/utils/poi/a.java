...
import com.baidu.mapapi.utils.poi.BaiduMapPoiSearch.BaiduMapPoiSearch_1;
import com.baidu.platform.comapi.a.c;

final class a implements com.baidu.platform.comapi.a.a.a<c> {
    ...
    public void a(HttpStateError httpStateError) {
        switch (BaiduMapPoiSearch_1.b[httpStateError.ordinal()]) {
            case 1:
    ...
    public void a(c cVar) {
        ...
        switch (BaiduMapPoiSearch_1.a[cVar.a().ordinal()]) {
            case 1:
