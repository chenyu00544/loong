...
public class BaiduMapPoiSearch {
    ...
    static /* synthetic */ class BaiduMapPoiSearch_1 {
        ...
        static {
            ...
            try {
                a[d.PANO_UID_ERROR.ordinal()] = 1;
            } catch (NoSuchFieldError e3) {
            }
            try {
                a[d.PANO_NOT_FOUND.ordinal()] = 2;
            } catch (NoSuchFieldError e4) {
            }
            try {
                a[d.PANO_NO_TOKEN.ordinal()] = 3;
            } catch (NoSuchFieldError e5) {
            }
            try {
                a[d.PANO_NO_ERROR.ordinal()] = 4;
    ...
    private static void b(PoiParaOption poiParaOption, Context context) {
        ...
        stringBuilder.append(poiParaOption.c.latitude);
        stringBuilder.append(",");
        stringBuilder.append(poiParaOption.c.longitude);
