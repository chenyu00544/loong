...
class b implements k {
    ...
    public void a(D d) {
        ...
        if (this.a.o != null) {
            this.a.o.onMapStatusChangeStart(MapStatus.a(d));
        }
    }
        ...
        try {
            ...
            if (optInt == 17) {
                ...
                if (this.a.i != null) {
                    ...
                    D.c = 0;
                    D.b = 0;
                    this.a.i.a(D, (int) ErrorCode.APP_NOT_BIND);
                }
    ...
    public void a(GL10 gl10, D d) {
        if (this.a.A != null) {
            this.a.A.onMapDrawFrame(gl10, MapStatus.a(d));
        }
    }
    ...
    public void b(D d) {
        if (this.a.o != null) {
            this.a.o.onMapStatusChange(MapStatus.a(d));
        }
    }
    ...
    public void c(D d) {
        ...
        if (this.a.o != null) {
            this.a.o.onMapStatusChangeFinish(MapStatus.a(d));
        }
    }
