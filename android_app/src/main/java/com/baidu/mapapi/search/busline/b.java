...
public class b {
    public static BusLineResult a(String str) {
        ...
        try {
            ...
            try {
                busLineResult.a(simpleDateFormat.parse(optJSONObject.optString(LogBuilder.KEY_START_TIME)));
                busLineResult.b(simpleDateFormat.parse(optJSONObject.optString(LogBuilder.KEY_END_TIME)));
