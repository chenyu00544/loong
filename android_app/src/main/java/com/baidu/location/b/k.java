...
public class k implements f {
    ...
    public static int cF = ErrorCode.APP_NOT_BIND;
    ...
    public static String if(h hVar, com.baidu.location.h.f fVar, Location location, String str, int i) {
        ...
        if (!TextUtils.isEmpty(bv)) {
            stringBuffer.append("&bc=").append(bv);
        }
        if (i == 0) {
            if (hVar != null) {
                str2 = c.a().int(hVar);
            ...
            if (location != null || fVar == null) {
                ...
                try {
                    ...
                    int dm = fVar.dm();
                    boolean di = fVar.di();
                    if (speed < cd && ((i2 == 1 || i2 == 0) && (dg < cc || di))) {
                        b3 = 1;
                    } else if (speed >= cz || (!(i2 == 1 || i2 == 0 || i2 == 3) || (dg >= cK && dm <= bO))) {
                        b3 = 3;
                    } else {
                        b3 = 2;
                    }
