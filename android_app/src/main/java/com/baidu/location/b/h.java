...
public class h implements f {
    ...
    class b {
        ...
        boolean a(a aVar) {
            return this.a.if(if(aVar)) == 0 && aVar.do < Math.max(this.do.do, this.if.do) + 1.0E-8d && aVar.do > Math.min(this.do.do, this.if.do) - 1.0E-8d && aVar.if < Math.max(this.do.if, this.if.if) + 1.0E-8d && aVar.if > Math.min(this.do.if, this.if.if) - 1.0E-8d;
        }

        double if(a aVar) {
            a aVar2 = new a(this.a, this.if.do - this.do.do, this.if.if - this.do.if);
            a aVar3 = new a(this.a, aVar.do - this.do.do, aVar.if - this.do.if);
            return (aVar2.do * aVar3.if) - (aVar2.if * aVar3.do);
        }
    }
    ...
    public boolean for(double d, double d2) {
        try {
            ...
            while (it.hasNext()) {
                ...
                int i2 = if(bVar.if(aVar));
                int i3 = if(bVar.do.if - aVar.if);
                int i4 = if(bVar.if.if - aVar.if);
