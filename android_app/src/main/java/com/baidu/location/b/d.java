...
public class d implements f {
    ...
    private class a extends m {
        ...
        public void au() {
            if (this.dh.bz.equals("dns.map.baidu.com") || System.currentTimeMillis() - this.dh.bs > 720000) {
                switch (c.a().cR()) {
                    case 1:
                        this.dh.bz = "111.13.100.247";
                        break;
                    case 2:
                        this.dh.bz = "111.206.37.190";
                        break;
                    case 3:
                        this.dh.bz = "180.97.33.196";
                        break;
                    default:
                        this.dh.bz = "dns.map.baidu.com";
                        break;
                }
            }
            this.c5 = "http://" + this.dh.bz + ":80/remotedns?pid=lbs-geolocation";
        }
        ...
        void ax() {
            if (System.currentTimeMillis() - this.dh.by < 1200000) {
                this.dh.Q();
                return;
            }
            String str;
            ...
            if (byName != null && byName.getHostAddress() != null && str != null && !"".equals(str)) {
                this.dh.bv = str;
                this.dh.br = byName.getHostAddress();
                this.dh.by = System.currentTimeMillis();
                this.dh.Q();
            }
        }
                ...
                try {
                    ...
                    if (jSONObject.getInt("errno") == 0 && jSONObject.has("data")) {
                        ...
                        if (jSONObject.has("switch")) {
                            this.dh.bx = jSONObject.getInt("switch");
                        }
                        this.dh.bs = System.currentTimeMillis();
                        ax();
                    }
                } catch (Exception e) {
                }
    ...
    public String V() {
        if (System.currentTimeMillis() - this.bu <= com.umeng.analytics.a.j || System.currentTimeMillis() - this.by >= 43200000 || this.bv == null || this.br == null) {
            return null;
        }
