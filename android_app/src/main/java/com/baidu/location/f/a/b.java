...
public final class b {
    ...
    static final class a {
        ...
        static a a(Context context) {
            ...
            String str = "";
            try {
                str = System.getString(context.getContentResolver(), do);
                if (TextUtils.isEmpty(str)) {
                    str = a(context, "");
                }
                System.putString(context.getContentResolver(), do, str);
                z = false;
            } catch (Exception e) {
    ...
    private static String a(String str) {
        ...
        try {
            ...
            fileReader.close();
            String[] split = new String(com.baidu.location.f.b.a.a(for, for, com.baidu.location.f.b.b.a(stringBuilder.toString().getBytes()))).split("=");
