...
class StrictLineReader implements Closeable {
    ...
    public String readLine() throws IOException {
        ...
        synchronized (this.in) {
            ...
            ByteArrayOutputStream strictLineReader_1 = new ByteArrayOutputStream((this.end - this.pos) + 80) {
            ...
            loop1:
            while (true) {
                strictLineReader_1.write(this.buf, this.pos, this.end - this.pos);
                this.end = -1;
                fillBuf();
                i = this.pos;
                while (i != this.end) {
            ...
            if (i != this.pos) {
                strictLineReader_1.write(this.buf, this.pos, i - this.pos);
            }
            this.pos = i + 1;
            str = strictLineReader_1.toString();
        }
        return str;
    }
