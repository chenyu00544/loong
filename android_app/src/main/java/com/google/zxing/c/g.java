...
final class g {
    ...
    private synchronized void a() {
        if (this.a.isEmpty()) {
            ...
            a(new int[]{ErrorCode.APP_NOT_BIND, 379}, "FR");
            a(new int[]{380}, "BG");
            a(new int[]{383}, "SI");
            a(new int[]{385}, "HR");
            a(new int[]{387}, "BA");
            ...
            a(new int[]{d_ResultType.SHORT_URL, 509}, "GB");
            a(new int[]{m_AppUI.MSG_PLACEFIELD_RELOAD}, "GR");
            a(new int[]{528}, "LB");
            a(new int[]{529}, "CY");
            a(new int[]{531}, "MK");
            a(new int[]{535}, "MT");
            ...
            a(new int[]{594}, "RO");
            a(new int[]{599}, "HU");
            a(new int[]{600, com.baidu.location.b.g.x}, "ZA");
            a(new int[]{603}, "GH");
            a(new int[]{608}, "BH");
            a(new int[]{609}, "MU");
            a(new int[]{611}, "MA");
