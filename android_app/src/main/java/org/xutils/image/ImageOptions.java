...
public class ImageOptions {
    ...
    public int hashCode() {
        ...
        int i2 = 1;
        int i3 = 0;
        int i4 = ((((this.e ? 1 : 0) + (((((((this.a * 31) + this.b) * 31) + this.c) * 31) + this.d) * 31)) * 31) + this.f) * 31;
        if (this.g) {
            i = 1;
        } else {
            i = 0;
    ...
    public String toString() {
        ...
        stringBuilder.append(this.a).append("_");
        stringBuilder.append(this.b).append("_");
        stringBuilder.append(this.c).append("_");
        stringBuilder.append(this.d).append("_");
        stringBuilder.append(this.f).append("_");
        stringBuilder.append(this.k).append("_");
        if (this.e) {
            i = 1;
        } else {
            i = 0;
        }
        stringBuilder.append(i).append(this.g ? 1 : 0).append(this.h ? 1 : 0);
        if (this.i) {
            i = 1;
        } else {
            i = 0;
