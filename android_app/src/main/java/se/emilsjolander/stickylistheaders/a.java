...
class a extends BaseAdapter implements h {
    ...
    private int e;
    private a f;
    private DataSetObserver g = new a_1(this);
    ...
    /* compiled from: AdapterWrapper */
    class a_1 extends DataSetObserver {
        final /* synthetic */ a a;
    ...
    private View a(WrapperView wrapperView, final int i) {
        View a = this.a.a(i, wrapperView.mHeader == null ? a() : wrapperView.mHeader, wrapperView);
        if (a == null) {
    ...
    public WrapperView b(int i, View view, ViewGroup viewGroup) {
        ...
        View view2 = this.a.getView(i, wrapperView.mItem, viewGroup);
        View view3 = null;
        if (b(i)) {
            a(wrapperView);
        } else {
        ...
        view.update(view2, view3, this.d, this.e);
        return view;
    }
