...
@section('content')
    ...
    <div class="warpper clearfix">
        <div class="title"><a href="javascript:history.go(-1);" class="s-back">返回</a>文章管理 - 添加文章</div>
        <div class="content">
            ...
            <div class="fromlist clearfix">
                <div class="main-info">
                    <form name="conf" action="{{url('admin/article/'.$article->article_id)}}" method="post" class="form-horizontal"
                        ...
                        <div class="switch-info">
                            ...
                            <div class="form-group">
                                <input type="hidden" name="parent_id" value="{{$article->cat_id}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4 n-wd400">
                                    <label class="radio-inline fl ml10">
                                        <input type="radio" name="is_open" value="1" @if($article->is_open == 1) checked @endif> 是
                                    </label>
                                    <label class="radio-inline fl ml10">
                                        <input type="radio" name="is_open" value="0" @if($article->is_open == 0) checked @endif> 否
                                    </label>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4 n-wd400">
                                    <label class="radio-inline fl ml10">
                                        <input type="radio" name="article_type" value="1" @if($article->article_type == 1) checked @endif> 置顶
                                    </label>
                                    <label class="radio-inline fl ml10">
                                        <input type="radio" name="article_type" value="0" @if($article->article_type == 0) checked @endif> 普通
                                    </label>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="link_url" class="form-control" value="{{$article->link}}"
                                           placeholder="外部链接">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="hidden" name="file_url" value="{{$article->file_url}}" class="fl">
                                    <span class="img-show fl">
                                    <a href="{{url($article->file_url_oss)}}" target="_blank" class="nyroModal">
                                        <i class="glyphicon glyphicon-picture top5"
                                           data-tooltipimg="{{$article->file_url_oss}}" ectype="tooltip"
                                ...
                                <div id="cate-add" class="clearfix">
                                    ...
                                    <div class="sort-list sort-list-one" style="width: 45%;margin-right: 0%">
                                        <div class="sort-list-warp">
                                            <div class="category-list ps-container ps-active-y">
                                                <ul class="sd-list">
                                                    @foreach($article->goods as $goods)
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="article" value="{{$article->article_id}}">
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        $(function () {
            ...
            $('.select-add').on('click', function () {
                ...
                if(ids.length > 0){
                    $.post("{{url('admin/article/change/goods')}}", {
                        '_token': "{{csrf_token()}}",
