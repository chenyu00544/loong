                            ...
                            <tr>
                                <td class="capt-td">
                                    <div class="fl wd-750">
                                        ...
                                        <p>
                                            <img src="{{url('api/web/captcha')}}" alt="captcha" class="captcha-img cursor"></p>
                                    </div>
                                    <div class="fl mar-left-20">
                                        <ul>
                                            <li class="wd80">
                                                <a class="cursor sel-all">
                                                    <input type="checkbox" name="captcha_register" id="captcha_register" value="1" @if($captcha['captcha']->value[0] != 0) checked="true" @endif>
                                            ...
                                            <li class="wd80">
                                                <a class="cursor sel-all">
                                                    <input type="checkbox" name="captcha_login" id="captcha_login" value="2" @if($captcha['captcha']->value[1] != 0) checked="true" @endif>
                                            ...
                                            <li class="wd80">
                                                <a class="cursor sel-all">
                                                    <input type="checkbox" name="captcha_comment" id="captcha_comment" value="4" @if($captcha['captcha']->value[2] != 0) checked="true" @endif>
                                            ...
                                            <li class="wd80">
                                                <a class="cursor sel-all">
                                                    <input type="checkbox" name="captcha_admin" id="captcha_admin" value="8" @if($captcha['captcha']->value[3] != 0) checked="true" @endif>
                                            ...
                                            <li class="wd80">
                                                <a class="cursor sel-all">
                                                    <input type="checkbox" name="captcha_message" id="captcha_message" value="16" @if($captcha['captcha']->value[4] != 0) checked="true" @endif>
                            ...
                            <tr>
                                <td class="capt-td">
                                    <div class="fl wd-750">
                                        ...
                                        <p class="blue td">选择“是”将在用户登录失败 3 次后才显示验证码，选择“否”将始终在登录时显示验证码。注意:只有在启用了用户登录验证码时本设置才有效</p>
                                    </div>
                            ...
                            <tr>
                                <td class="capt-td">
                                    ...
                                    <div class="fl mar-left-20 pad-top-13">
                                        <input type="text" name="captcha_width" class="form-control" value="{{$captcha['captcha_width']->value}}" placeholder="宽度">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td class="capt-td">
                                    ...
                                    <div class="fl mar-left-20 pad-top-13">
                                            <input type="text" name="captcha_height" class="form-control" value="{{$captcha['captcha_height']->value}}" placeholder="高度">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td class="capt-td">
                                    ...
                                    <div class="fl mar-left-20 pad-top-13">
                                        <input type="text" name="captcha_font_size" class="form-control" value="{{$captcha['captcha_font_size']->value}}" placeholder="验证码内容大小">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td class="capt-td">
                                    ...
                                    <div class="fl mar-left-20">
                                        <input type="text" name="captcha_length" class="form-control" value="{{$captcha['captcha_length']->value}}" placeholder="验证码位数">
                                    </div>
                                </td>
                            </tr>
                            <tr>
    ...
    <script>
        $(function () {
            $('.captcha-img').on('click', function () {
                $(this).attr('src', "{{url('api/web/captcha')}}");
            })
        });
    </script>
@endsection
