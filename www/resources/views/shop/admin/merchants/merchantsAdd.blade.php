                    ...
                    <form enctype="multipart/form-data" name="conf" action="{{url('admin/storelist')}}"
                                ...
                                <div class="merchants-section">
                                    ...
                                    @elseif($mst->steps_style == 1)
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <select name="shoprz_type" class="form-control input-sm shop_city">
                                                    <option value="0">请选择...</option>
                                            ...
                                            <div class="col-sm-3 subShoprz_type disn">
                                                <select name="subShoprz_type" class="form-control input-sm shop_city">
                                                    <option value="0">请选择...</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <select name="shop_categoryMain"
                                                        class="form-control input-sm shop_city">
                                                    <option value="0">请选择...</option>
                        ...
                        <div class="merchants-section">
                            ...
                            <div class="form-group seller-grade disn">
                                ...
                                <div class="col-sm-3">
                                    <select name="grade_id" class="form-control input-sm shop_city">
