    ...
    <div class="warpper clearfix">
        ...
        <div class="content">
            ...
            <div class="fromlist clearfix">
                <div class="main-info">
                    <form action="{{url('admin/sellergrade/'.$grade->id)}}" method="post" class="form-horizontal"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="grade_name" class="form-control input-sm"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="goods_sun" class="form-control input-sm"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="seller_temp" class="form-control input-sm"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="give_integral" class="form-control input-sm"
                                       value="{{$grade->give_integral}}"
                                       placeholder="">
                            </div>
                            %
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="rank_integral" class="form-control input-sm"
                                       value="{{$grade->rank_integral}}"
                                       placeholder="0">
                            </div>
                            %
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="pay_integral" class="form-control input-sm"
                                       value="{{$grade->pay_integral}}"
                                       placeholder="0">
                            </div>
                            %
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <label class="radio-inline fl">
                                    <input type="radio" name="white_bar" value="1"
                                           @if($grade->white_bar == 1) checked @endif> 是
                                </label>
                                <label class="radio-inline fl">
                                    <input type="radio" name="white_bar" value="0"
                                           @if($grade->white_bar == 0) checked @endif> 否
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                ...
                                <span class="img-show">
                                    <a href="{{url($grade->grade_img)}}"
                                       class="nyroModal">
                                        <i class="glyphicon glyphicon-picture top2"
                                           data-tooltipimg="{{url($grade->grade_img)}}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="file_url" class="form-control" value="{{$grade->grade_img}}"
                                       placeholder="或地址">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <textarea name="grade_introduce" class="form-control" row="5"
                                          placeholder="等级介绍"
                                          style="min-height:100px;">{{$grade->grade_introduce}}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                                    ...
                                    @foreach($ecs as $ec)
                                        <label class="mar-right-10">
                                            <input type="checkbox" name="criteria_name[]"
                                                   value="{{$ec->id}}"
                                                   @if(!empty($grade->entry_criteria[$ec->id])) checked @endif>{{$ec->criteria_name}}
                                        </label>
                                    @endforeach
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <label class="radio-inline fl">
                                    <input type="radio" name="is_open" value="1"
                                           @if($grade->is_open == 1) checked @endif> 是
                                </label>
                                <label class="radio-inline fl">
                                    <input type="radio" name="is_open" value="0"
                                           @if($grade->is_open == 0) checked @endif> 否
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <label class="radio-inline fl">
                                    <input type="radio" name="is_default" value="1"
                                           @if($grade->is_default == 1) checked @endif> 是
                                </label>
                                <label class="radio-inline fl">
                                    <input type="radio" name="is_default" value="0"
                                           @if($grade->is_default == 0) checked @endif> 否
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
