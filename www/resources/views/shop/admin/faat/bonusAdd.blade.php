...
@section('content')
    ...
    <div class="warpper clearfix">
        <div class="title"><a href="javascript:history.go(-1);" class="s-back">返回</a>促销管理 - 红包活动</div>
        <div class="content">
            <div class="tip">
                <div class="tip_title">
                    <i class="tip_icon"></i>
            ...
            <div class="fromlist clearfix">
                <div class="main-info">
                    <form name="brand" action="{{url('admin/bonus')}}" method="post" class="form-horizontal"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="type_name" class="form-control input-sm" value=""
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="type_money" class="form-control input-sm" value=""
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="min_goods_amount" class="form-control input-sm" value=""
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select name="send_type" class="form-control select input-sm wd120">
                                    <option value="0">按用户发放</option>
                                    <option value="1">按商品发放</option>
                                    <option value="2">按订单金额发放</option>
                                    <option value="3">线下发放的红包</option>
                                    <option value="4">自行领取</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group send_date" style="display: none;">
                        ...
                        <div class="form-group min_amount" style="display: none;">
