...
@section('content')
    ...
    <div class="warpper clearfix">
        <div class="title"><a href="javascript:history.go(-1);" class="s-back">返回</a>会员管理 - 编辑会员等级</div>
        <div class="content">
            <div class="tip">
                <div class="tip_title">
                    <i class="tip_icon"></i>
            ...
            <div class="fromlist clearfix">
                <div class="main-info">
                    <form name="conf" action="{{url('admin/userrank/'.$rank->rank_id)}}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" name="min_points" class="form-control" value="{{$rank->min_points}}"
                                       placeholder="积分下限">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" name="max_points" class="form-control" value="{{$rank->max_points}}"
                                       placeholder="积分上限">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <label class="label-tip">
                                    <input type="checkbox" name="show_price" value="1"
                                           class="checkbox check-all fl" @if($rank->show_price == 1) checked @endif><span
                            ...
                            <div class="col-sm-4">
                                <label class="label-tip">
                                    <input type="checkbox" name="special_rank" value="1"
                                           class="checkbox check-all fl" @if($rank->special_rank == 1) checked @endif><span
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" name="discount" class="form-control" value="{{$rank->discount}}"
                                       placeholder="初始折扣率">
                            </div>
                        </div>
                        <div class="form-group">
