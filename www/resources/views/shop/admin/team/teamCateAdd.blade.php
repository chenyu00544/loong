    ...
    <div class="warpper clearfix">
        ...
        <div class="content">
            ...
            <div class="fromlist clearfix">
                <div class="main-info">
                    <form name="brand" action="{{url('admin/teamcate')}}" method="post" class="form-horizontal"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="file" name="tc_img">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4 control-label">描述：</label>
                            <div class="col-sm-3">
                                <textarea class="form-control" rows="5" name="content" placeholder="描述"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
