...
<Nonce><![CDATA[%s]]></Nonce>
    ...
    public function sendTemplateMessage($data)
    {
	 ...
	 public function sendOneMessage($data)
    {
        if (!$this->access_token && !$this->checkAuth()) 
		{
			//echo "验证失败";
        ...
        $result = $this->http_post('https://api.weixin.qq.com/cgi-bin/message/template/subscribe?access_token='.$this->access_token, self::json_encode($data));
