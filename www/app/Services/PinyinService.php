...
class PinyinService
{
    public static function Pinyin($_String, $_Code = 'gb2312')
    {
        ...
        $str_len = self::str_len($_String);
        $str1 = iconv_substr($_String, 0, 1, 'utf-8');
        $str2 = iconv_substr($_String, 1, $str_len - 1, 'utf-8');
    ...
    public static function Arr_Combine($_Arr1, $_Arr2)
    {
