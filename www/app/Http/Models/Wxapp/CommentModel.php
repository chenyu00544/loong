...
class CommentModel extends Model
{
    ...
    {
        return $this->hasMany('App\Http\Models\Wxapp\CommentImgModel', 'comment_id', 'comment_id');
    }
    ...
    {
        return $this->hasMany('App\Http\Models\Wxapp\CommentModel', 'parent_id', 'comment_id');
    }
