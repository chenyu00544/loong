...
class CronController extends CommonController
{
    ...
    )
    {
        ...
        $this->task = ['order' => '订单到期处理', 'task' => '计划任务数据处理', 'notice_to_cb' => '红包优惠券到期提醒', 'notice_to_seller' => '新订单通知(商家)', 'notice_to_user' => '订单变化通知(用户)', 'clear_cart' => '清理购物车', 'team_task' => '设置拼团成团和失败团状态'];
    }
